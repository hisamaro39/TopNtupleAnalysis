 ...
 */
#ifndef ANATTRESTRUTHElectron_H
#define ANATTRESTRUTHElectron_H
...
class AnaTtresTruthElectron : public Analysis {
  public:
    AnaTtresTruthElectron(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresTruthElectron();
