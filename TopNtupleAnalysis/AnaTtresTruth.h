 ...
 */
#ifndef ANATTRESTRUTH_H
#define ANATTRESTRUTH_H
...
class AnaTtresTruth : public Analysis {
  public:
    AnaTtresTruth(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresTruth();
