 ...
 */
#ifndef ANATTRESMETTRIG_H
#define ANATTRESMETTRIG_H
...
class AnaTtresMetTrig : public Analysis {
  public:
    AnaTtresMetTrig(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresMetTrig();
