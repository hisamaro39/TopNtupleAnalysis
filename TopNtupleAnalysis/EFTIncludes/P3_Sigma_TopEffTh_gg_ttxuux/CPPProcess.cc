...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF4_5_3(w[3], w[4], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[32]);
  FFFF1_3(w[3], w[4], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFFF4_5_1(w[4], w[5], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[38]);
  FFFF1_1(w[4], w[5], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[39]); 
  FFFF1_6_1(w[4], w[5], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[40]);
  FFFF4_5_4(w[3], w[4], w[5], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[41]);
  FFFF1_4(w[3], w[4], w[5], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[42]); 
  ...
  FFFF4_5_0(w[45], w[4], w[5], w[44], pars->GC_16, pars->GC_17, amp[71]); 
  FFFF1_0(w[45], w[4], w[5], w[44], -pars->GC_13, amp[72]); 
  FFFF1_6_0(w[45], w[4], w[5], w[44], -pars->GC_11, -pars->GC_27, amp[73]); 
  ...
  FFFF4_5_0(w[3], w[4], w[59], w[44], pars->GC_16, pars->GC_17, amp[100]); 
  FFFF1_0(w[3], w[4], w[59], w[44], -pars->GC_13, amp[101]); 
  FFFF1_6_0(w[3], w[4], w[59], w[44], -pars->GC_11, -pars->GC_27, amp[102]); 
  ...
  FFFF4_5_0(w[64], w[4], w[5], w[65], pars->GC_16, pars->GC_17, amp[135]); 
  FFFF1_0(w[64], w[4], w[5], w[65], -pars->GC_13, amp[136]); 
  FFFF1_6_0(w[64], w[4], w[5], w[65], -pars->GC_11, -pars->GC_27, amp[137]); 
  ...
  FFFF4_5_0(w[64], w[4], w[59], w[2], pars->GC_16, pars->GC_17, amp[164]); 
  FFFF1_0(w[64], w[4], w[59], w[2], -pars->GC_13, amp[165]); 
  FFFF1_6_0(w[64], w[4], w[59], w[2], -pars->GC_11, -pars->GC_27, amp[166]); 
  ...
  FFFF4_5_0(w[3], w[4], w[88], w[65], pars->GC_16, pars->GC_17, amp[250]); 
  FFFF1_0(w[3], w[4], w[88], w[65], -pars->GC_13, amp[251]); 
  FFFF1_6_0(w[3], w[4], w[88], w[65], -pars->GC_11, -pars->GC_27, amp[252]); 
  ...
  FFFF4_5_0(w[45], w[4], w[88], w[2], pars->GC_16, pars->GC_17, amp[263]); 
  FFFF1_0(w[45], w[4], w[88], w[2], -pars->GC_13, amp[264]); 
  FFFF1_6_0(w[45], w[4], w[88], w[2], -pars->GC_11, -pars->GC_27, amp[265]); 
...
double CPPProcess::matrix_3_gg_ttxuux() 
{
  int i, j; 
  // Local variables
