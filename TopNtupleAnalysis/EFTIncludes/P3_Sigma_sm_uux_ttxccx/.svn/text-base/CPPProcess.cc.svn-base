...
// Process: u u~ > t t~ c c~ WEIGHTED<=4 @3
// Process: u u~ > t t~ d d~ WEIGHTED<=4 @3
// Process: u u~ > t t~ s s~ WEIGHTED<=4 @3
// Process: c c~ > t t~ u u~ WEIGHTED<=4 @3
// Process: c c~ > t t~ d d~ WEIGHTED<=4 @3
// Process: c c~ > t t~ s s~ WEIGHTED<=4 @3
// Process: d d~ > t t~ u u~ WEIGHTED<=4 @3
// Process: d d~ > t t~ c c~ WEIGHTED<=4 @3
// Process: d d~ > t t~ s s~ WEIGHTED<=4 @3
// Process: s s~ > t t~ u u~ WEIGHTED<=4 @3
// Process: s s~ > t t~ c c~ WEIGHTED<=4 @3
// Process: s s~ > t t~ d d~ WEIGHTED<=4 @3
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[5], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[7]); 
  ...
  FFV1_1(w[4], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  ...
  FFV1_0(w[11], w[4], w[10], pars->GC_11, amp[3]); 
