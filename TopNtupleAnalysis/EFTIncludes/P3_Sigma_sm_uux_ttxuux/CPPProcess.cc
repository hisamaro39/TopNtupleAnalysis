...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[0], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1P0_3(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_0(w[19], w[4], w[10], pars->GC_11, amp[10]); 
  FFV1_0(w[20], w[4], w[14], pars->GC_11, amp[11]); 
