...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[5], w[4], pars->GC_2, pars->ZERO, pars->ZERO, w[7]); 
  ...
  FFV1_2(w[5], w[6], pars->GC_2, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_1(w[4], w[6], pars->GC_2, pars->ZERO, pars->ZERO, w[32]); 
  ...
  FFV2_7_2(w[5], w[19], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[39]);
  FFV2_7_1(w[4], w[19], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[40]);
  FFFF4_5_2(w[3], w[5], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[41]);
  FFFF1_2(w[3], w[5], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[42]); 
  FFFF1_6_2(w[3], w[5], w[2], -pars->GC_11, -pars->GC_27, pars->ZERO,
      pars->ZERO, w[43]);
  FFFF4_5_1(w[4], w[5], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[44]);
  FFFF1_1(w[4], w[5], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[45]); 
  FFFF1_6_1(w[4], w[5], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[46]);
  FFFF4_5_4(w[3], w[4], w[5], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[47]);
  FFFF1_4(w[3], w[4], w[5], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[48]); 
  FFFF1_6_4(w[3], w[4], w[5], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[49]);
  FFFF4_5_3(w[3], w[4], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[50]);
  FFFF1_3(w[3], w[4], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[51]); 
  FFFF1_6_3(w[3], w[4], w[2], -pars->GC_11, -pars->GC_27, pars->ZERO,
      pars->ZERO, w[52]);
  FFV1P0_3(w[0], w[4], pars->GC_2, pars->ZERO, pars->ZERO, w[53]); 
  FFV1P0_3(w[5], w[1], pars->GC_2, pars->ZERO, pars->ZERO, w[54]); 
  ...
  FFV3_8_2(w[3], w[53], pars->GC_170, pars->GC_91, pars->mdl_MT, pars->mdl_WT,
      w[58]);
  FFV1P0_3(w[5], w[1], pars->GC_7, pars->ZERO, pars->ZERO, w[59]); 
  FFV2_7_3(w[5], w[1], pars->GC_59, pars->GC_69, pars->mdl_MZ, pars->mdl_WZ,
      w[60]);
  FFV1P0_3(w[0], w[4], pars->GC_7, pars->ZERO, pars->ZERO, w[61]); 
  ...
  FFV1_2(w[5], w[53], pars->GC_2, pars->ZERO, pars->ZERO, w[73]); 
  FFV1_1(w[1], w[53], pars->GC_2, pars->ZERO, pars->ZERO, w[74]); 
  FFV1_2(w[5], w[61], pars->GC_7, pars->ZERO, pars->ZERO, w[75]); 
  FFV1_1(w[1], w[61], pars->GC_7, pars->ZERO, pars->ZERO, w[76]); 
  FFV2_7_2(w[5], w[66], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[77]);
  FFV2_7_1(w[1], w[66], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[78]);
  FFFF4_5_1(w[1], w[5], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[79]);
  FFFF1_1(w[1], w[5], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[80]); 
  FFFF1_6_1(w[1], w[5], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[81]);
  FFFF4_5_4(w[3], w[1], w[5], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[82]);
  FFFF1_4(w[3], w[1], w[5], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[83]); 
  FFFF1_6_4(w[3], w[1], w[5], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[84]);
  FFFF4_5_3(w[3], w[1], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[85]);
  FFFF1_3(w[3], w[1], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[86]); 
  ...
  FFV1_0(w[31], w[4], w[30], pars->GC_2, amp[73]); 
  FFV1_0(w[5], w[32], w[30], pars->GC_2, amp[74]); 
  FFV1_0(w[31], w[4], w[33], pars->GC_2, amp[75]); 
  FFV1_0(w[5], w[32], w[33], pars->GC_2, amp[76]); 
  ...
  FFV2_7_0(w[31], w[4], w[34], pars->GC_59, pars->GC_69, amp[81]); 
  FFV2_7_0(w[5], w[32], w[34], pars->GC_59, pars->GC_69, amp[82]); 
  FFV2_7_0(w[31], w[4], w[35], pars->GC_59, pars->GC_69, amp[83]); 
  FFV2_7_0(w[5], w[32], w[35], pars->GC_59, pars->GC_69, amp[84]); 
  FFV2_7_0(w[31], w[4], w[36], pars->GC_59, pars->GC_69, amp[85]); 
  FFV2_7_0(w[5], w[32], w[36], pars->GC_59, pars->GC_69, amp[86]); 
  FFV1_0(w[37], w[4], w[30], pars->GC_2, amp[87]); 
  FFV1_0(w[5], w[38], w[30], pars->GC_2, amp[88]); 
  FFV1_0(w[37], w[4], w[33], pars->GC_2, amp[89]); 
  FFV1_0(w[5], w[38], w[33], pars->GC_2, amp[90]); 
  ...
  FFV2_7_0(w[37], w[4], w[34], pars->GC_59, pars->GC_69, amp[95]); 
  FFV2_7_0(w[5], w[38], w[34], pars->GC_59, pars->GC_69, amp[96]); 
  FFV2_7_0(w[37], w[4], w[35], pars->GC_59, pars->GC_69, amp[97]); 
  FFV2_7_0(w[5], w[38], w[35], pars->GC_59, pars->GC_69, amp[98]); 
  FFV2_7_0(w[37], w[4], w[36], pars->GC_59, pars->GC_69, amp[99]); 
  FFV2_7_0(w[5], w[38], w[36], pars->GC_59, pars->GC_69, amp[100]); 
  FFV1_0(w[39], w[4], w[30], pars->GC_2, amp[101]); 
  FFV1_0(w[5], w[40], w[30], pars->GC_2, amp[102]); 
  FFV1_0(w[39], w[4], w[33], pars->GC_2, amp[103]); 
  FFV1_0(w[5], w[40], w[33], pars->GC_2, amp[104]); 
  ...
  FFV2_7_0(w[39], w[4], w[34], pars->GC_59, pars->GC_69, amp[109]); 
  FFV2_7_0(w[5], w[40], w[34], pars->GC_59, pars->GC_69, amp[110]); 
  FFV2_7_0(w[39], w[4], w[35], pars->GC_59, pars->GC_69, amp[111]); 
  FFV2_7_0(w[5], w[40], w[35], pars->GC_59, pars->GC_69, amp[112]); 
  FFV2_7_0(w[39], w[4], w[36], pars->GC_59, pars->GC_69, amp[113]); 
  FFV2_7_0(w[5], w[40], w[36], pars->GC_59, pars->GC_69, amp[114]); 
  FFV1_0(w[41], w[4], w[6], pars->GC_2, amp[115]); 
  FFV1_0(w[42], w[4], w[6], pars->GC_2, amp[116]); 
  FFV1_0(w[43], w[4], w[6], pars->GC_2, amp[117]); 
  FFV1_0(w[41], w[4], w[14], pars->GC_7, amp[118]); 
  FFV1_0(w[42], w[4], w[14], pars->GC_7, amp[119]); 
  FFV1_0(w[43], w[4], w[14], pars->GC_7, amp[120]); 
  FFV2_7_0(w[41], w[4], w[19], pars->GC_59, pars->GC_69, amp[121]); 
  FFV2_7_0(w[42], w[4], w[19], pars->GC_59, pars->GC_69, amp[122]); 
  FFV2_7_0(w[43], w[4], w[19], pars->GC_59, pars->GC_69, amp[123]); 
  ...
  FFV1_0(w[5], w[50], w[6], pars->GC_2, amp[142]); 
  FFV1_0(w[5], w[51], w[6], pars->GC_2, amp[143]); 
  FFV1_0(w[5], w[52], w[6], pars->GC_2, amp[144]); 
  FFV1_0(w[5], w[50], w[14], pars->GC_7, amp[145]); 
  FFV1_0(w[5], w[51], w[14], pars->GC_7, amp[146]); 
  FFV1_0(w[5], w[52], w[14], pars->GC_7, amp[147]); 
  FFV2_7_0(w[5], w[50], w[19], pars->GC_59, pars->GC_69, amp[148]); 
  FFV2_7_0(w[5], w[51], w[19], pars->GC_59, pars->GC_69, amp[149]); 
  FFV2_7_0(w[5], w[52], w[19], pars->GC_59, pars->GC_69, amp[150]); 
  ...
  FFV1_0(w[73], w[1], w[30], pars->GC_2, amp[224]); 
  FFV1_0(w[5], w[74], w[30], pars->GC_2, amp[225]); 
  FFV1_0(w[73], w[1], w[33], pars->GC_2, amp[226]); 
  FFV1_0(w[5], w[74], w[33], pars->GC_2, amp[227]); 
  FFV1_0(w[73], w[1], w[27], pars->GC_7, amp[228]); 
  FFV1_0(w[5], w[74], w[27], pars->GC_7, amp[229]); 
  FFV1_0(w[73], w[1], w[28], pars->GC_7, amp[230]); 
  FFV1_0(w[5], w[74], w[28], pars->GC_7, amp[231]); 
  FFV2_7_0(w[73], w[1], w[34], pars->GC_59, pars->GC_69, amp[232]); 
  FFV2_7_0(w[5], w[74], w[34], pars->GC_59, pars->GC_69, amp[233]); 
  FFV2_7_0(w[73], w[1], w[35], pars->GC_59, pars->GC_69, amp[234]); 
  FFV2_7_0(w[5], w[74], w[35], pars->GC_59, pars->GC_69, amp[235]); 
  FFV2_7_0(w[73], w[1], w[36], pars->GC_59, pars->GC_69, amp[236]); 
  FFV2_7_0(w[5], w[74], w[36], pars->GC_59, pars->GC_69, amp[237]); 
  FFV1_0(w[75], w[1], w[30], pars->GC_2, amp[238]); 
  FFV1_0(w[5], w[76], w[30], pars->GC_2, amp[239]); 
  FFV1_0(w[75], w[1], w[33], pars->GC_2, amp[240]); 
  FFV1_0(w[5], w[76], w[33], pars->GC_2, amp[241]); 
  FFV1_0(w[75], w[1], w[27], pars->GC_7, amp[242]); 
  FFV1_0(w[5], w[76], w[27], pars->GC_7, amp[243]); 
  FFV1_0(w[75], w[1], w[28], pars->GC_7, amp[244]); 
  FFV1_0(w[5], w[76], w[28], pars->GC_7, amp[245]); 
  FFV2_7_0(w[75], w[1], w[34], pars->GC_59, pars->GC_69, amp[246]); 
  FFV2_7_0(w[5], w[76], w[34], pars->GC_59, pars->GC_69, amp[247]); 
  FFV2_7_0(w[75], w[1], w[35], pars->GC_59, pars->GC_69, amp[248]); 
  FFV2_7_0(w[5], w[76], w[35], pars->GC_59, pars->GC_69, amp[249]); 
  FFV2_7_0(w[75], w[1], w[36], pars->GC_59, pars->GC_69, amp[250]); 
  FFV2_7_0(w[5], w[76], w[36], pars->GC_59, pars->GC_69, amp[251]); 
  FFV1_0(w[77], w[1], w[30], pars->GC_2, amp[252]); 
  FFV1_0(w[5], w[78], w[30], pars->GC_2, amp[253]); 
  FFV1_0(w[77], w[1], w[33], pars->GC_2, amp[254]); 
  FFV1_0(w[5], w[78], w[33], pars->GC_2, amp[255]); 
  FFV1_0(w[77], w[1], w[27], pars->GC_7, amp[256]); 
  FFV1_0(w[5], w[78], w[27], pars->GC_7, amp[257]); 
  FFV1_0(w[77], w[1], w[28], pars->GC_7, amp[258]); 
  FFV1_0(w[5], w[78], w[28], pars->GC_7, amp[259]); 
  FFV2_7_0(w[77], w[1], w[34], pars->GC_59, pars->GC_69, amp[260]); 
  FFV2_7_0(w[5], w[78], w[34], pars->GC_59, pars->GC_69, amp[261]); 
  FFV2_7_0(w[77], w[1], w[35], pars->GC_59, pars->GC_69, amp[262]); 
  FFV2_7_0(w[5], w[78], w[35], pars->GC_59, pars->GC_69, amp[263]); 
  FFV2_7_0(w[77], w[1], w[36], pars->GC_59, pars->GC_69, amp[264]); 
  FFV2_7_0(w[5], w[78], w[36], pars->GC_59, pars->GC_69, amp[265]); 
  FFV1_0(w[41], w[1], w[53], pars->GC_2, amp[266]); 
  FFV1_0(w[42], w[1], w[53], pars->GC_2, amp[267]); 
  FFV1_0(w[43], w[1], w[53], pars->GC_2, amp[268]); 
  FFV1_0(w[41], w[1], w[61], pars->GC_7, amp[269]); 
  FFV1_0(w[42], w[1], w[61], pars->GC_7, amp[270]); 
  FFV1_0(w[43], w[1], w[61], pars->GC_7, amp[271]); 
  FFV2_7_0(w[41], w[1], w[66], pars->GC_59, pars->GC_69, amp[272]); 
  FFV2_7_0(w[42], w[1], w[66], pars->GC_59, pars->GC_69, amp[273]); 
  FFV2_7_0(w[43], w[1], w[66], pars->GC_59, pars->GC_69, amp[274]); 
  ...
  FFV1_0(w[5], w[85], w[53], pars->GC_2, amp[293]); 
  FFV1_0(w[5], w[86], w[53], pars->GC_2, amp[294]); 
  FFV1_0(w[5], w[87], w[53], pars->GC_2, amp[295]); 
  FFV1_0(w[5], w[85], w[61], pars->GC_7, amp[296]); 
  FFV1_0(w[5], w[86], w[61], pars->GC_7, amp[297]); 
  FFV1_0(w[5], w[87], w[61], pars->GC_7, amp[298]); 
  FFV2_7_0(w[5], w[85], w[66], pars->GC_59, pars->GC_69, amp[299]); 
  FFV2_7_0(w[5], w[86], w[66], pars->GC_59, pars->GC_69, amp[300]); 
  FFV2_7_0(w[5], w[87], w[66], pars->GC_59, pars->GC_69, amp[301]); 
  FFV1_0(w[88], w[4], w[30], pars->GC_2, amp[302]); 
  FFV1_0(w[89], w[4], w[54], pars->GC_2, amp[303]); 
  FFV1_0(w[88], w[4], w[33], pars->GC_2, amp[304]); 
  FFV1_0(w[90], w[4], w[54], pars->GC_2, amp[305]); 
  FFV1_0(w[88], w[4], w[27], pars->GC_7, amp[306]); 
  FFV1_0(w[91], w[4], w[54], pars->GC_2, amp[307]); 
  FFV1_0(w[88], w[4], w[28], pars->GC_7, amp[308]); 
  FFV1_0(w[92], w[4], w[54], pars->GC_2, amp[309]); 
  FFV2_7_0(w[88], w[4], w[34], pars->GC_59, pars->GC_69, amp[310]); 
  FFV1_0(w[93], w[4], w[54], pars->GC_2, amp[311]); 
  FFV2_7_0(w[88], w[4], w[35], pars->GC_59, pars->GC_69, amp[312]); 
  FFV1_0(w[94], w[4], w[54], pars->GC_2, amp[313]); 
  FFV2_7_0(w[88], w[4], w[36], pars->GC_59, pars->GC_69, amp[314]); 
  FFV1_0(w[95], w[4], w[54], pars->GC_2, amp[315]); 
  FFV1_0(w[96], w[4], w[30], pars->GC_2, amp[316]); 
  FFV1_0(w[89], w[4], w[59], pars->GC_7, amp[317]); 
  FFV1_0(w[96], w[4], w[33], pars->GC_2, amp[318]); 
  FFV1_0(w[90], w[4], w[59], pars->GC_7, amp[319]); 
  FFV1_0(w[96], w[4], w[27], pars->GC_7, amp[320]); 
  FFV1_0(w[91], w[4], w[59], pars->GC_7, amp[321]); 
  FFV1_0(w[96], w[4], w[28], pars->GC_7, amp[322]); 
  FFV1_0(w[92], w[4], w[59], pars->GC_7, amp[323]); 
  FFV2_7_0(w[96], w[4], w[34], pars->GC_59, pars->GC_69, amp[324]); 
  FFV1_0(w[93], w[4], w[59], pars->GC_7, amp[325]); 
  FFV2_7_0(w[96], w[4], w[35], pars->GC_59, pars->GC_69, amp[326]); 
  FFV1_0(w[94], w[4], w[59], pars->GC_7, amp[327]); 
  FFV2_7_0(w[96], w[4], w[36], pars->GC_59, pars->GC_69, amp[328]); 
  FFV1_0(w[95], w[4], w[59], pars->GC_7, amp[329]); 
  FFV1_0(w[97], w[4], w[30], pars->GC_2, amp[330]); 
  FFV2_7_0(w[89], w[4], w[60], pars->GC_59, pars->GC_69, amp[331]); 
  FFV1_0(w[97], w[4], w[33], pars->GC_2, amp[332]); 
  FFV2_7_0(w[90], w[4], w[60], pars->GC_59, pars->GC_69, amp[333]); 
  FFV1_0(w[97], w[4], w[27], pars->GC_7, amp[334]); 
  FFV2_7_0(w[91], w[4], w[60], pars->GC_59, pars->GC_69, amp[335]); 
  FFV1_0(w[97], w[4], w[28], pars->GC_7, amp[336]); 
  FFV2_7_0(w[92], w[4], w[60], pars->GC_59, pars->GC_69, amp[337]); 
  FFV2_7_0(w[97], w[4], w[34], pars->GC_59, pars->GC_69, amp[338]); 
  FFV2_7_0(w[93], w[4], w[60], pars->GC_59, pars->GC_69, amp[339]); 
  FFV2_7_0(w[97], w[4], w[35], pars->GC_59, pars->GC_69, amp[340]); 
  FFV2_7_0(w[94], w[4], w[60], pars->GC_59, pars->GC_69, amp[341]); 
  FFV2_7_0(w[97], w[4], w[36], pars->GC_59, pars->GC_69, amp[342]); 
  FFV2_7_0(w[95], w[4], w[60], pars->GC_59, pars->GC_69, amp[343]); 
  ...
  FFV1_0(w[98], w[1], w[30], pars->GC_2, amp[353]); 
  FFV1_0(w[89], w[1], w[7], pars->GC_2, amp[354]); 
  FFV1_0(w[98], w[1], w[33], pars->GC_2, amp[355]); 
  FFV1_0(w[90], w[1], w[7], pars->GC_2, amp[356]); 
  FFV1_0(w[98], w[1], w[27], pars->GC_7, amp[357]); 
  FFV1_0(w[91], w[1], w[7], pars->GC_2, amp[358]); 
  FFV1_0(w[98], w[1], w[28], pars->GC_7, amp[359]); 
  FFV1_0(w[92], w[1], w[7], pars->GC_2, amp[360]); 
  FFV2_7_0(w[98], w[1], w[34], pars->GC_59, pars->GC_69, amp[361]); 
  FFV1_0(w[93], w[1], w[7], pars->GC_2, amp[362]); 
  FFV2_7_0(w[98], w[1], w[35], pars->GC_59, pars->GC_69, amp[363]); 
  FFV1_0(w[94], w[1], w[7], pars->GC_2, amp[364]); 
  FFV2_7_0(w[98], w[1], w[36], pars->GC_59, pars->GC_69, amp[365]); 
  FFV1_0(w[95], w[1], w[7], pars->GC_2, amp[366]); 
  FFV1_0(w[99], w[1], w[30], pars->GC_2, amp[367]); 
  FFV1_0(w[89], w[1], w[12], pars->GC_7, amp[368]); 
  FFV1_0(w[99], w[1], w[33], pars->GC_2, amp[369]); 
  FFV1_0(w[90], w[1], w[12], pars->GC_7, amp[370]); 
  FFV1_0(w[99], w[1], w[27], pars->GC_7, amp[371]); 
  FFV1_0(w[91], w[1], w[12], pars->GC_7, amp[372]); 
  FFV1_0(w[99], w[1], w[28], pars->GC_7, amp[373]); 
  FFV1_0(w[92], w[1], w[12], pars->GC_7, amp[374]); 
  FFV2_7_0(w[99], w[1], w[34], pars->GC_59, pars->GC_69, amp[375]); 
  FFV1_0(w[93], w[1], w[12], pars->GC_7, amp[376]); 
  FFV2_7_0(w[99], w[1], w[35], pars->GC_59, pars->GC_69, amp[377]); 
  FFV1_0(w[94], w[1], w[12], pars->GC_7, amp[378]); 
  FFV2_7_0(w[99], w[1], w[36], pars->GC_59, pars->GC_69, amp[379]); 
  FFV1_0(w[95], w[1], w[12], pars->GC_7, amp[380]); 
  FFV1_0(w[100], w[1], w[30], pars->GC_2, amp[381]); 
  FFV2_7_0(w[89], w[1], w[13], pars->GC_59, pars->GC_69, amp[382]); 
  FFV1_0(w[100], w[1], w[33], pars->GC_2, amp[383]); 
  FFV2_7_0(w[90], w[1], w[13], pars->GC_59, pars->GC_69, amp[384]); 
  FFV1_0(w[100], w[1], w[27], pars->GC_7, amp[385]); 
  FFV2_7_0(w[91], w[1], w[13], pars->GC_59, pars->GC_69, amp[386]); 
  FFV1_0(w[100], w[1], w[28], pars->GC_7, amp[387]); 
  FFV2_7_0(w[92], w[1], w[13], pars->GC_59, pars->GC_69, amp[388]); 
  FFV2_7_0(w[100], w[1], w[34], pars->GC_59, pars->GC_69, amp[389]); 
  FFV2_7_0(w[93], w[1], w[13], pars->GC_59, pars->GC_69, amp[390]); 
  FFV2_7_0(w[100], w[1], w[35], pars->GC_59, pars->GC_69, amp[391]); 
  FFV2_7_0(w[94], w[1], w[13], pars->GC_59, pars->GC_69, amp[392]); 
  FFV2_7_0(w[100], w[1], w[36], pars->GC_59, pars->GC_69, amp[393]); 
  FFV2_7_0(w[95], w[1], w[13], pars->GC_59, pars->GC_69, amp[394]); 
  ...
  FFV1_0(w[101], w[4], w[54], pars->GC_2, amp[404]); 
  FFV1_0(w[102], w[4], w[54], pars->GC_2, amp[405]); 
  FFV1_0(w[103], w[4], w[54], pars->GC_2, amp[406]); 
  FFV1_0(w[101], w[4], w[59], pars->GC_7, amp[407]); 
  FFV1_0(w[102], w[4], w[59], pars->GC_7, amp[408]); 
  FFV1_0(w[103], w[4], w[59], pars->GC_7, amp[409]); 
  FFV2_7_0(w[101], w[4], w[60], pars->GC_59, pars->GC_69, amp[410]); 
  FFV2_7_0(w[102], w[4], w[60], pars->GC_59, pars->GC_69, amp[411]); 
  FFV2_7_0(w[103], w[4], w[60], pars->GC_59, pars->GC_69, amp[412]); 
  FFV1_0(w[101], w[1], w[7], pars->GC_2, amp[413]); 
  FFV1_0(w[102], w[1], w[7], pars->GC_2, amp[414]); 
  FFV1_0(w[103], w[1], w[7], pars->GC_2, amp[415]); 
  FFV1_0(w[101], w[1], w[12], pars->GC_7, amp[416]); 
  FFV1_0(w[102], w[1], w[12], pars->GC_7, amp[417]); 
  FFV1_0(w[103], w[1], w[12], pars->GC_7, amp[418]); 
  FFV2_7_0(w[101], w[1], w[13], pars->GC_59, pars->GC_69, amp[419]); 
  FFV2_7_0(w[102], w[1], w[13], pars->GC_59, pars->GC_69, amp[420]); 
  FFV2_7_0(w[103], w[1], w[13], pars->GC_59, pars->GC_69, amp[421]); 
...
double CPPProcess::matrix_3_uux_ttxuux() 
{
  int i, j; 
  // Local variables
