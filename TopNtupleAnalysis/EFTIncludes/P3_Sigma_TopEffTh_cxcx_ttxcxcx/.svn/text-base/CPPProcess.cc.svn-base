...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_7_1(w[0], w[66], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[78]);
  FFFF4_5_3(w[5], w[2], w[0], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[79]);
  FFFF3_3(w[5], w[2], w[0], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[80]); 
  FFFF3_7_3(w[5], w[2], w[0], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[81]);
  FFFF4_5_2(w[5], w[3], w[0], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[82]);
  FFFF3_2(w[5], w[3], w[0], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[83]); 
  FFFF3_7_2(w[5], w[3], w[0], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[84]);
  FFFF4_5_1(w[2], w[3], w[0], pars->GC_17, pars->GC_16, pars->ZERO, pars->ZERO,
      w[85]);
  FFFF3_1(w[2], w[3], w[0], pars->GC_13, pars->ZERO, pars->ZERO, w[86]); 
  ...
  FFV2_7_2(w[4], w[13], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[100]);
  FFFF4_5_4(w[4], w[2], w[3], pars->GC_17, pars->GC_16, pars->ZERO, pars->ZERO,
      w[101]);
  FFFF3_4(w[4], w[2], w[3], pars->GC_13, pars->ZERO, pars->ZERO, w[102]); 
  FFFF3_7_4(w[4], w[2], w[3], pars->GC_11, pars->GC_27, pars->ZERO, pars->ZERO,
      w[103]);
  FFFF4_5_3(w[4], w[2], w[0], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[104]);
  FFFF3_3(w[4], w[2], w[0], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[105]); 
  FFFF3_7_3(w[4], w[2], w[0], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[106]);
  FFFF4_5_3(w[4], w[2], w[1], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[107]);
  FFFF3_3(w[4], w[2], w[1], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[108]); 
  FFFF3_7_3(w[4], w[2], w[1], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[109]);
  FFFF4_5_2(w[4], w[3], w[0], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[110]);
  FFFF3_2(w[4], w[3], w[0], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[111]); 
  FFFF3_7_2(w[4], w[3], w[0], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[112]);
  FFFF4_5_2(w[4], w[3], w[1], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[113]);
  FFFF3_2(w[4], w[3], w[1], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[114]); 
  FFFF3_7_2(w[4], w[3], w[1], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[115]);
...
double CPPProcess::matrix_3_cxcx_ttxcxcx() 
{
  int i, j; 
  // Local variables
