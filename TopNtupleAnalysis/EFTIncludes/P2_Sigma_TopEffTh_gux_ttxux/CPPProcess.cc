...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[4], w[0], pars->GC_7, pars->ZERO, pars->ZERO, w[5]); 
  ...
  FFV1P0_3(w[4], w[1], pars->GC_2, pars->ZERO, pars->ZERO, w[14]); 
  FFV1P0_3(w[4], w[1], pars->GC_7, pars->ZERO, pars->ZERO, w[15]); 
  ...
  FFV3_8_2(w[3], w[0], pars->GC_145, pars->GC_79, pars->mdl_MT, pars->mdl_WT,
      w[19]);
  FFV1_1(w[1], w[0], pars->GC_7, pars->ZERO, pars->ZERO, w[20]); 
  ...
  FFV1_0(w[5], w[1], w[7], pars->GC_2, amp[1]); 
  FFV1_0(w[5], w[1], w[8], pars->GC_7, amp[2]); 
  FFV1_0(w[5], w[1], w[9], pars->GC_7, amp[3]); 
  FFV2_7_0(w[5], w[1], w[10], pars->GC_59, pars->GC_69, amp[4]); 
  FFV2_7_0(w[5], w[1], w[11], pars->GC_59, pars->GC_69, amp[5]); 
  FFV2_7_0(w[5], w[1], w[12], pars->GC_59, pars->GC_69, amp[6]); 
  FFFF4_5_0(w[3], w[1], w[5], w[2], pars->GC_16, pars->GC_17, amp[7]); 
  FFFF1_0(w[3], w[1], w[5], w[2], -pars->GC_13, amp[8]); 
  FFFF1_6_0(w[3], w[1], w[5], w[2], -pars->GC_11, -pars->GC_27, amp[9]); 
  ...
  FFFF4_5_0(w[3], w[1], w[4], w[13], pars->GC_16, pars->GC_17, amp[20]); 
  FFFF1_0(w[3], w[1], w[4], w[13], -pars->GC_13, amp[21]); 
  FFFF1_6_0(w[3], w[1], w[4], w[13], -pars->GC_11, -pars->GC_27, amp[22]); 
  ...
  FFFF4_5_0(w[18], w[1], w[4], w[2], pars->GC_16, pars->GC_17, amp[33]); 
  FFFF1_0(w[18], w[1], w[4], w[2], -pars->GC_13, amp[34]); 
  FFFF1_6_0(w[18], w[1], w[4], w[2], -pars->GC_11, -pars->GC_27, amp[35]); 
  FFV1_0(w[4], w[20], w[6], pars->GC_2, amp[36]); 
  FFV1_0(w[4], w[20], w[7], pars->GC_2, amp[37]); 
  FFV1_0(w[4], w[20], w[8], pars->GC_7, amp[38]); 
  FFV1_0(w[4], w[20], w[9], pars->GC_7, amp[39]); 
  FFV2_7_0(w[4], w[20], w[10], pars->GC_59, pars->GC_69, amp[40]); 
  FFV2_7_0(w[4], w[20], w[11], pars->GC_59, pars->GC_69, amp[41]); 
  FFV2_7_0(w[4], w[20], w[12], pars->GC_59, pars->GC_69, amp[42]); 
  FFFF4_5_0(w[3], w[20], w[4], w[2], pars->GC_16, pars->GC_17, amp[43]); 
  FFFF1_0(w[3], w[20], w[4], w[2], -pars->GC_13, amp[44]); 
  FFFF1_6_0(w[3], w[20], w[4], w[2], -pars->GC_11, -pars->GC_27, amp[45]); 
  ...
  FFV1_0(w[4], w[1], w[22], pars->GC_7, amp[50]); 

}
double CPPProcess::matrix_2_gux_ttxux() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./2. * amp[25] + 1./2. * amp[26] + 1./2. * amp[31] - amp[33] -
  ...
  jamp[2] = +amp[10] + amp[11] - 1./6. * amp[12] - 1./6. * amp[13] + amp[14] +
      ...
      * amp[22] + amp[23] + amp[24] - 1./6. * amp[25] - 1./6. * amp[26] +
      ...
      amp[34] + 1./6. * amp[35];
  jamp[3] = +1./2. * amp[2] + 1./2. * amp[3] - amp[7] - 1./2. * amp[9] + 1./2.
