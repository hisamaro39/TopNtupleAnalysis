...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF4_5_3(w[3], w[4], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[62]);
  FFFF1_3(w[3], w[4], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[63]); 
  ...
  FFFF4_5_1(w[4], w[0], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[79]);
  FFFF1_1(w[4], w[0], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[80]); 
  ...
  FFFF4_5_4(w[3], w[4], w[0], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[84]);
  FFFF1_4(w[3], w[4], w[0], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[85]); 
...
double CPPProcess::matrix_3_ud_ttxud() 
{
  int i, j; 
  // Local variables
