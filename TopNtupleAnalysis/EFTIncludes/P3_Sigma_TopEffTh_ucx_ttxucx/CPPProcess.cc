...
double CPPProcess::matrix_3_ucx_ttxucx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[1] = -1./4. * std::complex<double> (0, 1) * amp[26] - 1./4. * amp[30] -
  ...
  jamp[2] = +1./4. * std::complex<double> (0, 1) * amp[26] - 1./4. * amp[27] -
  ...
  jamp[3] = -1./2. * amp[6] - 1./2. * amp[7] - 1./2. * amp[8] - 1./2. * amp[9]
      ...
      * amp[94] - 1./2. * amp[105] - 1./2. * amp[106] - 1./2. * amp[107] -
      ...
      amp[225];
  jamp[4] = -1./2. * amp[20] - 1./2. * amp[21] - 1./2. * amp[22] - 1./2. *
