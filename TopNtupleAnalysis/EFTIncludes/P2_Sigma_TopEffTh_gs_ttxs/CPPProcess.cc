...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[1], w[4], pars->GC_1, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_0(w[5], w[4], w[7], pars->GC_1, amp[1]); 
  FFV1_0(w[5], w[4], w[8], pars->GC_7, amp[2]); 
  FFV1_0(w[5], w[4], w[9], pars->GC_7, amp[3]); 
  FFV2_4_0(w[5], w[4], w[10], pars->GC_58, pars->GC_69, amp[4]); 
  FFV2_4_0(w[5], w[4], w[11], pars->GC_58, pars->GC_69, amp[5]); 
  FFV2_4_0(w[5], w[4], w[12], pars->GC_58, pars->GC_69, amp[6]); 
  FFFF4_5_0(w[5], w[2], w[3], w[4], pars->GC_15, pars->GC_16, amp[7]); 
  FFFF1_0(w[5], w[2], w[3], w[4], -pars->GC_12, amp[8]); 
  FFFF1_6_0(w[5], w[2], w[3], w[4], -pars->GC_10, -pars->GC_26, amp[9]); 
  ...
  FFFF4_5_0(w[1], w[13], w[3], w[4], pars->GC_15, pars->GC_16, amp[20]); 
  FFFF1_0(w[1], w[13], w[3], w[4], -pars->GC_12, amp[21]); 
  FFFF1_6_0(w[1], w[13], w[3], w[4], -pars->GC_10, -pars->GC_26, amp[22]); 
  ...
  FFFF4_5_0(w[1], w[2], w[18], w[4], pars->GC_15, pars->GC_16, amp[33]); 
  FFFF1_0(w[1], w[2], w[18], w[4], -pars->GC_12, amp[34]); 
  FFFF1_6_0(w[1], w[2], w[18], w[4], -pars->GC_10, -pars->GC_26, amp[35]); 
  FFV1_0(w[1], w[20], w[6], pars->GC_1, amp[36]); 
  FFV1_0(w[1], w[20], w[7], pars->GC_1, amp[37]); 
  FFV1_0(w[1], w[20], w[8], pars->GC_7, amp[38]); 
  FFV1_0(w[1], w[20], w[9], pars->GC_7, amp[39]); 
  FFV2_4_0(w[1], w[20], w[10], pars->GC_58, pars->GC_69, amp[40]); 
  FFV2_4_0(w[1], w[20], w[11], pars->GC_58, pars->GC_69, amp[41]); 
  FFV2_4_0(w[1], w[20], w[12], pars->GC_58, pars->GC_69, amp[42]); 
  FFFF4_5_0(w[1], w[2], w[3], w[20], pars->GC_15, pars->GC_16, amp[43]); 
  FFFF1_0(w[1], w[2], w[3], w[20], -pars->GC_12, amp[44]); 
  FFFF1_6_0(w[1], w[2], w[3], w[20], -pars->GC_10, -pars->GC_26, amp[45]); 
...
double CPPProcess::matrix_2_gs_ttxs() 
{
  int i, j; 
  // Local variables
