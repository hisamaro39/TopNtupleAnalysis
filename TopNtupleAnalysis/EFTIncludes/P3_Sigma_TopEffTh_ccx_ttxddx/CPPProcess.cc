...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF4_5_3(w[0], w[2], w[1], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[69]);
  FFFF3_3(w[0], w[2], w[1], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[70]); 
  FFFF3_7_3(w[0], w[2], w[1], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[71]);
  FFFF4_5_2(w[0], w[3], w[1], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[72]);
  FFFF3_2(w[0], w[3], w[1], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[73]); 
...
double CPPProcess::matrix_3_ccx_ttxddx() 
{
  int i, j; 
  // Local variables
