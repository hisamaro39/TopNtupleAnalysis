...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV3_8_2(w[3], w[6], pars->GC_170, pars->GC_91, pars->mdl_MT, pars->mdl_WT,
      w[11]);
  FFV1P0_3(w[1], w[5], pars->GC_7, pars->ZERO, pars->ZERO, w[12]); 
  FFV2_7_3(w[1], w[5], pars->GC_59, pars->GC_69, pars->mdl_MZ, pars->mdl_WZ,
      w[13]);
  FFV1P0_3(w[0], w[4], pars->GC_7, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV3_8_2(w[3], w[14], pars->GC_145, pars->GC_79, pars->mdl_MT, pars->mdl_WT,
      w[18]);
  FFV2_7_3(w[0], w[4], pars->GC_59, pars->GC_69, pars->mdl_MZ, pars->mdl_WZ,
      w[19]);
  ...
  FFV1_2(w[1], w[6], pars->GC_2, pars->ZERO, pars->ZERO, w[31]); 
  FFV1_1(w[5], w[6], pars->GC_2, pars->ZERO, pars->ZERO, w[32]); 
  ...
  FFV1_2(w[1], w[14], pars->GC_7, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[5], w[14], pars->GC_7, pars->ZERO, pars->ZERO, w[38]); 
  FFV2_7_2(w[1], w[19], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[39]);
  FFV2_7_1(w[5], w[19], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[40]);
  FFFF4_5_4(w[1], w[2], w[3], pars->GC_17, pars->GC_16, pars->ZERO, pars->ZERO,
      w[41]);
  FFFF3_4(w[1], w[2], w[3], pars->GC_13, pars->ZERO, pars->ZERO, w[42]); 
  FFFF3_7_4(w[1], w[2], w[3], pars->GC_11, pars->GC_27, pars->ZERO, pars->ZERO,
      w[43]);
  FFFF4_5_3(w[1], w[2], w[5], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[44]);
  FFFF3_3(w[1], w[2], w[5], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[45]); 
  FFFF3_7_3(w[1], w[2], w[5], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[46]);
  FFFF4_5_2(w[1], w[3], w[5], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[47]);
  FFFF3_2(w[1], w[3], w[5], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[48]); 
  FFFF3_7_2(w[1], w[3], w[5], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[49]);
  FFFF4_5_1(w[2], w[3], w[5], pars->GC_17, pars->GC_16, pars->ZERO, pars->ZERO,
      w[50]);
  FFFF3_1(w[2], w[3], w[5], pars->GC_13, pars->ZERO, pars->ZERO, w[51]); 
  FFFF3_7_1(w[2], w[3], w[5], pars->GC_11, pars->GC_27, pars->ZERO, pars->ZERO,
      w[52]);
  FFV1P0_3(w[0], w[5], pars->GC_2, pars->ZERO, pars->ZERO, w[53]); 
  FFV1P0_3(w[1], w[4], pars->GC_2, pars->ZERO, pars->ZERO, w[54]); 
  ...
  FFV3_8_2(w[3], w[53], pars->GC_170, pars->GC_91, pars->mdl_MT, pars->mdl_WT,
      w[58]);
  FFV1P0_3(w[1], w[4], pars->GC_7, pars->ZERO, pars->ZERO, w[59]); 
  FFV2_7_3(w[1], w[4], pars->GC_59, pars->GC_69, pars->mdl_MZ, pars->mdl_WZ,
      w[60]);
  FFV1P0_3(w[0], w[5], pars->GC_7, pars->ZERO, pars->ZERO, w[61]); 
  ...
  FFV3_8_2(w[3], w[61], pars->GC_145, pars->GC_79, pars->mdl_MT, pars->mdl_WT,
      w[65]);
  FFV2_7_3(w[0], w[5], pars->GC_59, pars->GC_69, pars->mdl_MZ, pars->mdl_WZ,
      w[66]);
  ...
  FFV1_2(w[1], w[53], pars->GC_2, pars->ZERO, pars->ZERO, w[73]); 
  FFV1_1(w[4], w[53], pars->GC_2, pars->ZERO, pars->ZERO, w[74]); 
  FFV1_2(w[1], w[61], pars->GC_7, pars->ZERO, pars->ZERO, w[75]); 
  FFV1_1(w[4], w[61], pars->GC_7, pars->ZERO, pars->ZERO, w[76]); 
  FFV2_7_2(w[1], w[66], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[77]);
  FFV2_7_1(w[4], w[66], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[78]);
  FFFF4_5_3(w[1], w[2], w[4], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[79]);
  FFFF3_3(w[1], w[2], w[4], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[80]); 
  FFFF3_7_3(w[1], w[2], w[4], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[81]);
  FFFF4_5_2(w[1], w[3], w[4], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[82]);
  FFFF3_2(w[1], w[3], w[4], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[83]); 
  FFFF3_7_2(w[1], w[3], w[4], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[84]);
  FFFF4_5_1(w[2], w[3], w[4], pars->GC_17, pars->GC_16, pars->ZERO, pars->ZERO,
      w[85]);
  FFFF3_1(w[2], w[3], w[4], pars->GC_13, pars->ZERO, pars->ZERO, w[86]); 
  FFFF3_7_1(w[2], w[3], w[4], pars->GC_11, pars->GC_27, pars->ZERO, pars->ZERO,
      w[87]);
  FFV1_2(w[0], w[54], pars->GC_2, pars->ZERO, pars->ZERO, w[88]); 
  FFV1_2(w[0], w[30], pars->GC_2, pars->ZERO, pars->ZERO, w[89]); 
  FFV1_2(w[0], w[33], pars->GC_2, pars->ZERO, pars->ZERO, w[90]); 
  FFV1_2(w[0], w[27], pars->GC_7, pars->ZERO, pars->ZERO, w[91]); 
  FFV1_2(w[0], w[28], pars->GC_7, pars->ZERO, pars->ZERO, w[92]); 
  ...
  FFV2_7_2(w[0], w[36], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[95]);
  FFV1_2(w[0], w[59], pars->GC_7, pars->ZERO, pars->ZERO, w[96]); 
  FFV2_7_2(w[0], w[60], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[97]);
  FFV1_2(w[0], w[7], pars->GC_2, pars->ZERO, pars->ZERO, w[98]); 
  FFV1_2(w[0], w[12], pars->GC_7, pars->ZERO, pars->ZERO, w[99]); 
  FFV2_7_2(w[0], w[13], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[100]);
  FFFF4_5_4(w[0], w[2], w[3], pars->GC_17, pars->GC_16, pars->ZERO, pars->ZERO,
      w[101]);
  FFFF3_4(w[0], w[2], w[3], pars->GC_13, pars->ZERO, pars->ZERO, w[102]); 
  FFFF3_7_4(w[0], w[2], w[3], pars->GC_11, pars->GC_27, pars->ZERO, pars->ZERO,
      w[103]);
  FFFF4_5_3(w[0], w[2], w[4], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[104]);
  FFFF3_3(w[0], w[2], w[4], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[105]); 
  FFFF3_7_3(w[0], w[2], w[4], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[106]);
  FFFF4_5_3(w[0], w[2], w[5], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[107]);
  FFFF3_3(w[0], w[2], w[5], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[108]); 
  FFFF3_7_3(w[0], w[2], w[5], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[109]);
  FFFF4_5_2(w[0], w[3], w[4], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[110]);
  FFFF3_2(w[0], w[3], w[4], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[111]); 
  FFFF3_7_2(w[0], w[3], w[4], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[112]);
  FFFF4_5_2(w[0], w[3], w[5], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[113]);
  FFFF3_2(w[0], w[3], w[5], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[114]); 
  FFFF3_7_2(w[0], w[3], w[5], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[115]);
  ...
  FFV1_0(w[31], w[5], w[30], pars->GC_2, amp[73]); 
  FFV1_0(w[1], w[32], w[30], pars->GC_2, amp[74]); 
  FFV1_0(w[31], w[5], w[33], pars->GC_2, amp[75]); 
  FFV1_0(w[1], w[32], w[33], pars->GC_2, amp[76]); 
  FFV1_0(w[31], w[5], w[27], pars->GC_7, amp[77]); 
  FFV1_0(w[1], w[32], w[27], pars->GC_7, amp[78]); 
  FFV1_0(w[31], w[5], w[28], pars->GC_7, amp[79]); 
  FFV1_0(w[1], w[32], w[28], pars->GC_7, amp[80]); 
  FFV2_7_0(w[31], w[5], w[34], pars->GC_59, pars->GC_69, amp[81]); 
  FFV2_7_0(w[1], w[32], w[34], pars->GC_59, pars->GC_69, amp[82]); 
  FFV2_7_0(w[31], w[5], w[35], pars->GC_59, pars->GC_69, amp[83]); 
  FFV2_7_0(w[1], w[32], w[35], pars->GC_59, pars->GC_69, amp[84]); 
  FFV2_7_0(w[31], w[5], w[36], pars->GC_59, pars->GC_69, amp[85]); 
  FFV2_7_0(w[1], w[32], w[36], pars->GC_59, pars->GC_69, amp[86]); 
  FFV1_0(w[37], w[5], w[30], pars->GC_2, amp[87]); 
  FFV1_0(w[1], w[38], w[30], pars->GC_2, amp[88]); 
  FFV1_0(w[37], w[5], w[33], pars->GC_2, amp[89]); 
  FFV1_0(w[1], w[38], w[33], pars->GC_2, amp[90]); 
  FFV1_0(w[37], w[5], w[27], pars->GC_7, amp[91]); 
  FFV1_0(w[1], w[38], w[27], pars->GC_7, amp[92]); 
  FFV1_0(w[37], w[5], w[28], pars->GC_7, amp[93]); 
  FFV1_0(w[1], w[38], w[28], pars->GC_7, amp[94]); 
  FFV2_7_0(w[37], w[5], w[34], pars->GC_59, pars->GC_69, amp[95]); 
  FFV2_7_0(w[1], w[38], w[34], pars->GC_59, pars->GC_69, amp[96]); 
  FFV2_7_0(w[37], w[5], w[35], pars->GC_59, pars->GC_69, amp[97]); 
  FFV2_7_0(w[1], w[38], w[35], pars->GC_59, pars->GC_69, amp[98]); 
  FFV2_7_0(w[37], w[5], w[36], pars->GC_59, pars->GC_69, amp[99]); 
  FFV2_7_0(w[1], w[38], w[36], pars->GC_59, pars->GC_69, amp[100]); 
  FFV1_0(w[39], w[5], w[30], pars->GC_2, amp[101]); 
  FFV1_0(w[1], w[40], w[30], pars->GC_2, amp[102]); 
  FFV1_0(w[39], w[5], w[33], pars->GC_2, amp[103]); 
  FFV1_0(w[1], w[40], w[33], pars->GC_2, amp[104]); 
  FFV1_0(w[39], w[5], w[27], pars->GC_7, amp[105]); 
  FFV1_0(w[1], w[40], w[27], pars->GC_7, amp[106]); 
  FFV1_0(w[39], w[5], w[28], pars->GC_7, amp[107]); 
  FFV1_0(w[1], w[40], w[28], pars->GC_7, amp[108]); 
  FFV2_7_0(w[39], w[5], w[34], pars->GC_59, pars->GC_69, amp[109]); 
  FFV2_7_0(w[1], w[40], w[34], pars->GC_59, pars->GC_69, amp[110]); 
  FFV2_7_0(w[39], w[5], w[35], pars->GC_59, pars->GC_69, amp[111]); 
  FFV2_7_0(w[1], w[40], w[35], pars->GC_59, pars->GC_69, amp[112]); 
  FFV2_7_0(w[39], w[5], w[36], pars->GC_59, pars->GC_69, amp[113]); 
  FFV2_7_0(w[1], w[40], w[36], pars->GC_59, pars->GC_69, amp[114]); 
  FFV1_0(w[41], w[5], w[6], pars->GC_2, amp[115]); 
  FFV1_0(w[42], w[5], w[6], pars->GC_2, amp[116]); 
  FFV1_0(w[43], w[5], w[6], pars->GC_2, amp[117]); 
  FFV1_0(w[41], w[5], w[14], pars->GC_7, amp[118]); 
  FFV1_0(w[42], w[5], w[14], pars->GC_7, amp[119]); 
  FFV1_0(w[43], w[5], w[14], pars->GC_7, amp[120]); 
  FFV2_7_0(w[41], w[5], w[19], pars->GC_59, pars->GC_69, amp[121]); 
  FFV2_7_0(w[42], w[5], w[19], pars->GC_59, pars->GC_69, amp[122]); 
  FFV2_7_0(w[43], w[5], w[19], pars->GC_59, pars->GC_69, amp[123]); 
  ...
  FFV1_0(w[1], w[50], w[6], pars->GC_2, amp[142]); 
  FFV1_0(w[1], w[51], w[6], pars->GC_2, amp[143]); 
  FFV1_0(w[1], w[52], w[6], pars->GC_2, amp[144]); 
  FFV1_0(w[1], w[50], w[14], pars->GC_7, amp[145]); 
  FFV1_0(w[1], w[51], w[14], pars->GC_7, amp[146]); 
  FFV1_0(w[1], w[52], w[14], pars->GC_7, amp[147]); 
  FFV2_7_0(w[1], w[50], w[19], pars->GC_59, pars->GC_69, amp[148]); 
  FFV2_7_0(w[1], w[51], w[19], pars->GC_59, pars->GC_69, amp[149]); 
  FFV2_7_0(w[1], w[52], w[19], pars->GC_59, pars->GC_69, amp[150]); 
  ...
  FFV1_0(w[73], w[4], w[30], pars->GC_2, amp[224]); 
  FFV1_0(w[1], w[74], w[30], pars->GC_2, amp[225]); 
  FFV1_0(w[73], w[4], w[33], pars->GC_2, amp[226]); 
  FFV1_0(w[1], w[74], w[33], pars->GC_2, amp[227]); 
  FFV1_0(w[73], w[4], w[27], pars->GC_7, amp[228]); 
  FFV1_0(w[1], w[74], w[27], pars->GC_7, amp[229]); 
  FFV1_0(w[73], w[4], w[28], pars->GC_7, amp[230]); 
  FFV1_0(w[1], w[74], w[28], pars->GC_7, amp[231]); 
  FFV2_7_0(w[73], w[4], w[34], pars->GC_59, pars->GC_69, amp[232]); 
  FFV2_7_0(w[1], w[74], w[34], pars->GC_59, pars->GC_69, amp[233]); 
  FFV2_7_0(w[73], w[4], w[35], pars->GC_59, pars->GC_69, amp[234]); 
  FFV2_7_0(w[1], w[74], w[35], pars->GC_59, pars->GC_69, amp[235]); 
  FFV2_7_0(w[73], w[4], w[36], pars->GC_59, pars->GC_69, amp[236]); 
  FFV2_7_0(w[1], w[74], w[36], pars->GC_59, pars->GC_69, amp[237]); 
  FFV1_0(w[75], w[4], w[30], pars->GC_2, amp[238]); 
  FFV1_0(w[1], w[76], w[30], pars->GC_2, amp[239]); 
  FFV1_0(w[75], w[4], w[33], pars->GC_2, amp[240]); 
  FFV1_0(w[1], w[76], w[33], pars->GC_2, amp[241]); 
  FFV1_0(w[75], w[4], w[27], pars->GC_7, amp[242]); 
  FFV1_0(w[1], w[76], w[27], pars->GC_7, amp[243]); 
  FFV1_0(w[75], w[4], w[28], pars->GC_7, amp[244]); 
  FFV1_0(w[1], w[76], w[28], pars->GC_7, amp[245]); 
  FFV2_7_0(w[75], w[4], w[34], pars->GC_59, pars->GC_69, amp[246]); 
  FFV2_7_0(w[1], w[76], w[34], pars->GC_59, pars->GC_69, amp[247]); 
  FFV2_7_0(w[75], w[4], w[35], pars->GC_59, pars->GC_69, amp[248]); 
  FFV2_7_0(w[1], w[76], w[35], pars->GC_59, pars->GC_69, amp[249]); 
  FFV2_7_0(w[75], w[4], w[36], pars->GC_59, pars->GC_69, amp[250]); 
  FFV2_7_0(w[1], w[76], w[36], pars->GC_59, pars->GC_69, amp[251]); 
  FFV1_0(w[77], w[4], w[30], pars->GC_2, amp[252]); 
  FFV1_0(w[1], w[78], w[30], pars->GC_2, amp[253]); 
  FFV1_0(w[77], w[4], w[33], pars->GC_2, amp[254]); 
  FFV1_0(w[1], w[78], w[33], pars->GC_2, amp[255]); 
  FFV1_0(w[77], w[4], w[27], pars->GC_7, amp[256]); 
  FFV1_0(w[1], w[78], w[27], pars->GC_7, amp[257]); 
  FFV1_0(w[77], w[4], w[28], pars->GC_7, amp[258]); 
  FFV1_0(w[1], w[78], w[28], pars->GC_7, amp[259]); 
  FFV2_7_0(w[77], w[4], w[34], pars->GC_59, pars->GC_69, amp[260]); 
  FFV2_7_0(w[1], w[78], w[34], pars->GC_59, pars->GC_69, amp[261]); 
  FFV2_7_0(w[77], w[4], w[35], pars->GC_59, pars->GC_69, amp[262]); 
  FFV2_7_0(w[1], w[78], w[35], pars->GC_59, pars->GC_69, amp[263]); 
  FFV2_7_0(w[77], w[4], w[36], pars->GC_59, pars->GC_69, amp[264]); 
  FFV2_7_0(w[1], w[78], w[36], pars->GC_59, pars->GC_69, amp[265]); 
  FFV1_0(w[41], w[4], w[53], pars->GC_2, amp[266]); 
  FFV1_0(w[42], w[4], w[53], pars->GC_2, amp[267]); 
  FFV1_0(w[43], w[4], w[53], pars->GC_2, amp[268]); 
  FFV1_0(w[41], w[4], w[61], pars->GC_7, amp[269]); 
  FFV1_0(w[42], w[4], w[61], pars->GC_7, amp[270]); 
  FFV1_0(w[43], w[4], w[61], pars->GC_7, amp[271]); 
  FFV2_7_0(w[41], w[4], w[66], pars->GC_59, pars->GC_69, amp[272]); 
  FFV2_7_0(w[42], w[4], w[66], pars->GC_59, pars->GC_69, amp[273]); 
  FFV2_7_0(w[43], w[4], w[66], pars->GC_59, pars->GC_69, amp[274]); 
  ...
  FFV1_0(w[1], w[85], w[53], pars->GC_2, amp[293]); 
  FFV1_0(w[1], w[86], w[53], pars->GC_2, amp[294]); 
  FFV1_0(w[1], w[87], w[53], pars->GC_2, amp[295]); 
  FFV1_0(w[1], w[85], w[61], pars->GC_7, amp[296]); 
  FFV1_0(w[1], w[86], w[61], pars->GC_7, amp[297]); 
  FFV1_0(w[1], w[87], w[61], pars->GC_7, amp[298]); 
  FFV2_7_0(w[1], w[85], w[66], pars->GC_59, pars->GC_69, amp[299]); 
  FFV2_7_0(w[1], w[86], w[66], pars->GC_59, pars->GC_69, amp[300]); 
  FFV2_7_0(w[1], w[87], w[66], pars->GC_59, pars->GC_69, amp[301]); 
  FFV1_0(w[88], w[5], w[30], pars->GC_2, amp[302]); 
  FFV1_0(w[89], w[5], w[54], pars->GC_2, amp[303]); 
  FFV1_0(w[88], w[5], w[33], pars->GC_2, amp[304]); 
  FFV1_0(w[90], w[5], w[54], pars->GC_2, amp[305]); 
  FFV1_0(w[88], w[5], w[27], pars->GC_7, amp[306]); 
  FFV1_0(w[91], w[5], w[54], pars->GC_2, amp[307]); 
  FFV1_0(w[88], w[5], w[28], pars->GC_7, amp[308]); 
  FFV1_0(w[92], w[5], w[54], pars->GC_2, amp[309]); 
  FFV2_7_0(w[88], w[5], w[34], pars->GC_59, pars->GC_69, amp[310]); 
  FFV1_0(w[93], w[5], w[54], pars->GC_2, amp[311]); 
  FFV2_7_0(w[88], w[5], w[35], pars->GC_59, pars->GC_69, amp[312]); 
  FFV1_0(w[94], w[5], w[54], pars->GC_2, amp[313]); 
  FFV2_7_0(w[88], w[5], w[36], pars->GC_59, pars->GC_69, amp[314]); 
  FFV1_0(w[95], w[5], w[54], pars->GC_2, amp[315]); 
  FFV1_0(w[96], w[5], w[30], pars->GC_2, amp[316]); 
  FFV1_0(w[89], w[5], w[59], pars->GC_7, amp[317]); 
  FFV1_0(w[96], w[5], w[33], pars->GC_2, amp[318]); 
  FFV1_0(w[90], w[5], w[59], pars->GC_7, amp[319]); 
  FFV1_0(w[96], w[5], w[27], pars->GC_7, amp[320]); 
  FFV1_0(w[91], w[5], w[59], pars->GC_7, amp[321]); 
  FFV1_0(w[96], w[5], w[28], pars->GC_7, amp[322]); 
  FFV1_0(w[92], w[5], w[59], pars->GC_7, amp[323]); 
  FFV2_7_0(w[96], w[5], w[34], pars->GC_59, pars->GC_69, amp[324]); 
  FFV1_0(w[93], w[5], w[59], pars->GC_7, amp[325]); 
  FFV2_7_0(w[96], w[5], w[35], pars->GC_59, pars->GC_69, amp[326]); 
  FFV1_0(w[94], w[5], w[59], pars->GC_7, amp[327]); 
  FFV2_7_0(w[96], w[5], w[36], pars->GC_59, pars->GC_69, amp[328]); 
  FFV1_0(w[95], w[5], w[59], pars->GC_7, amp[329]); 
  FFV1_0(w[97], w[5], w[30], pars->GC_2, amp[330]); 
  FFV2_7_0(w[89], w[5], w[60], pars->GC_59, pars->GC_69, amp[331]); 
  FFV1_0(w[97], w[5], w[33], pars->GC_2, amp[332]); 
  FFV2_7_0(w[90], w[5], w[60], pars->GC_59, pars->GC_69, amp[333]); 
  FFV1_0(w[97], w[5], w[27], pars->GC_7, amp[334]); 
  FFV2_7_0(w[91], w[5], w[60], pars->GC_59, pars->GC_69, amp[335]); 
  FFV1_0(w[97], w[5], w[28], pars->GC_7, amp[336]); 
  FFV2_7_0(w[92], w[5], w[60], pars->GC_59, pars->GC_69, amp[337]); 
  FFV2_7_0(w[97], w[5], w[34], pars->GC_59, pars->GC_69, amp[338]); 
  FFV2_7_0(w[93], w[5], w[60], pars->GC_59, pars->GC_69, amp[339]); 
  FFV2_7_0(w[97], w[5], w[35], pars->GC_59, pars->GC_69, amp[340]); 
  FFV2_7_0(w[94], w[5], w[60], pars->GC_59, pars->GC_69, amp[341]); 
  FFV2_7_0(w[97], w[5], w[36], pars->GC_59, pars->GC_69, amp[342]); 
  FFV2_7_0(w[95], w[5], w[60], pars->GC_59, pars->GC_69, amp[343]); 
  FFV1_0(w[0], w[50], w[54], pars->GC_2, amp[344]); 
  FFV1_0(w[0], w[51], w[54], pars->GC_2, amp[345]); 
  FFV1_0(w[0], w[52], w[54], pars->GC_2, amp[346]); 
  FFV1_0(w[0], w[50], w[59], pars->GC_7, amp[347]); 
  FFV1_0(w[0], w[51], w[59], pars->GC_7, amp[348]); 
  FFV1_0(w[0], w[52], w[59], pars->GC_7, amp[349]); 
  FFV2_7_0(w[0], w[50], w[60], pars->GC_59, pars->GC_69, amp[350]); 
  FFV2_7_0(w[0], w[51], w[60], pars->GC_59, pars->GC_69, amp[351]); 
  FFV2_7_0(w[0], w[52], w[60], pars->GC_59, pars->GC_69, amp[352]); 
  FFV1_0(w[98], w[4], w[30], pars->GC_2, amp[353]); 
  FFV1_0(w[89], w[4], w[7], pars->GC_2, amp[354]); 
  FFV1_0(w[98], w[4], w[33], pars->GC_2, amp[355]); 
  FFV1_0(w[90], w[4], w[7], pars->GC_2, amp[356]); 
  FFV1_0(w[98], w[4], w[27], pars->GC_7, amp[357]); 
  FFV1_0(w[91], w[4], w[7], pars->GC_2, amp[358]); 
  FFV1_0(w[98], w[4], w[28], pars->GC_7, amp[359]); 
  FFV1_0(w[92], w[4], w[7], pars->GC_2, amp[360]); 
  FFV2_7_0(w[98], w[4], w[34], pars->GC_59, pars->GC_69, amp[361]); 
  FFV1_0(w[93], w[4], w[7], pars->GC_2, amp[362]); 
  FFV2_7_0(w[98], w[4], w[35], pars->GC_59, pars->GC_69, amp[363]); 
  FFV1_0(w[94], w[4], w[7], pars->GC_2, amp[364]); 
  FFV2_7_0(w[98], w[4], w[36], pars->GC_59, pars->GC_69, amp[365]); 
  FFV1_0(w[95], w[4], w[7], pars->GC_2, amp[366]); 
  FFV1_0(w[99], w[4], w[30], pars->GC_2, amp[367]); 
  FFV1_0(w[89], w[4], w[12], pars->GC_7, amp[368]); 
  FFV1_0(w[99], w[4], w[33], pars->GC_2, amp[369]); 
  FFV1_0(w[90], w[4], w[12], pars->GC_7, amp[370]); 
  FFV1_0(w[99], w[4], w[27], pars->GC_7, amp[371]); 
  FFV1_0(w[91], w[4], w[12], pars->GC_7, amp[372]); 
  FFV1_0(w[99], w[4], w[28], pars->GC_7, amp[373]); 
  FFV1_0(w[92], w[4], w[12], pars->GC_7, amp[374]); 
  FFV2_7_0(w[99], w[4], w[34], pars->GC_59, pars->GC_69, amp[375]); 
  FFV1_0(w[93], w[4], w[12], pars->GC_7, amp[376]); 
  FFV2_7_0(w[99], w[4], w[35], pars->GC_59, pars->GC_69, amp[377]); 
  FFV1_0(w[94], w[4], w[12], pars->GC_7, amp[378]); 
  FFV2_7_0(w[99], w[4], w[36], pars->GC_59, pars->GC_69, amp[379]); 
  FFV1_0(w[95], w[4], w[12], pars->GC_7, amp[380]); 
  FFV1_0(w[100], w[4], w[30], pars->GC_2, amp[381]); 
  FFV2_7_0(w[89], w[4], w[13], pars->GC_59, pars->GC_69, amp[382]); 
  FFV1_0(w[100], w[4], w[33], pars->GC_2, amp[383]); 
  FFV2_7_0(w[90], w[4], w[13], pars->GC_59, pars->GC_69, amp[384]); 
  FFV1_0(w[100], w[4], w[27], pars->GC_7, amp[385]); 
  FFV2_7_0(w[91], w[4], w[13], pars->GC_59, pars->GC_69, amp[386]); 
  FFV1_0(w[100], w[4], w[28], pars->GC_7, amp[387]); 
  FFV2_7_0(w[92], w[4], w[13], pars->GC_59, pars->GC_69, amp[388]); 
  FFV2_7_0(w[100], w[4], w[34], pars->GC_59, pars->GC_69, amp[389]); 
  FFV2_7_0(w[93], w[4], w[13], pars->GC_59, pars->GC_69, amp[390]); 
  FFV2_7_0(w[100], w[4], w[35], pars->GC_59, pars->GC_69, amp[391]); 
  FFV2_7_0(w[94], w[4], w[13], pars->GC_59, pars->GC_69, amp[392]); 
  FFV2_7_0(w[100], w[4], w[36], pars->GC_59, pars->GC_69, amp[393]); 
  FFV2_7_0(w[95], w[4], w[13], pars->GC_59, pars->GC_69, amp[394]); 
  FFV1_0(w[0], w[85], w[7], pars->GC_2, amp[395]); 
  FFV1_0(w[0], w[86], w[7], pars->GC_2, amp[396]); 
  FFV1_0(w[0], w[87], w[7], pars->GC_2, amp[397]); 
  FFV1_0(w[0], w[85], w[12], pars->GC_7, amp[398]); 
  FFV1_0(w[0], w[86], w[12], pars->GC_7, amp[399]); 
  FFV1_0(w[0], w[87], w[12], pars->GC_7, amp[400]); 
  FFV2_7_0(w[0], w[85], w[13], pars->GC_59, pars->GC_69, amp[401]); 
  FFV2_7_0(w[0], w[86], w[13], pars->GC_59, pars->GC_69, amp[402]); 
  FFV2_7_0(w[0], w[87], w[13], pars->GC_59, pars->GC_69, amp[403]); 
  FFV1_0(w[101], w[5], w[54], pars->GC_2, amp[404]); 
  FFV1_0(w[102], w[5], w[54], pars->GC_2, amp[405]); 
  FFV1_0(w[103], w[5], w[54], pars->GC_2, amp[406]); 
  FFV1_0(w[101], w[5], w[59], pars->GC_7, amp[407]); 
  FFV1_0(w[102], w[5], w[59], pars->GC_7, amp[408]); 
  FFV1_0(w[103], w[5], w[59], pars->GC_7, amp[409]); 
  FFV2_7_0(w[101], w[5], w[60], pars->GC_59, pars->GC_69, amp[410]); 
  FFV2_7_0(w[102], w[5], w[60], pars->GC_59, pars->GC_69, amp[411]); 
  FFV2_7_0(w[103], w[5], w[60], pars->GC_59, pars->GC_69, amp[412]); 
  FFV1_0(w[101], w[4], w[7], pars->GC_2, amp[413]); 
  FFV1_0(w[102], w[4], w[7], pars->GC_2, amp[414]); 
  FFV1_0(w[103], w[4], w[7], pars->GC_2, amp[415]); 
  FFV1_0(w[101], w[4], w[12], pars->GC_7, amp[416]); 
  FFV1_0(w[102], w[4], w[12], pars->GC_7, amp[417]); 
  FFV1_0(w[103], w[4], w[12], pars->GC_7, amp[418]); 
  FFV2_7_0(w[101], w[4], w[13], pars->GC_59, pars->GC_69, amp[419]); 
  FFV2_7_0(w[102], w[4], w[13], pars->GC_59, pars->GC_69, amp[420]); 
  FFV2_7_0(w[103], w[4], w[13], pars->GC_59, pars->GC_69, amp[421]); 
...
double CPPProcess::matrix_3_cc_ttxcc() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = -1./4. * std::complex<double> (0, 1) * amp[26] + 1./4. * amp[27] +
  ...
  jamp[4] = +amp[0] + amp[1] + amp[2] + amp[3] + amp[4] + amp[5] - 1./6. *
