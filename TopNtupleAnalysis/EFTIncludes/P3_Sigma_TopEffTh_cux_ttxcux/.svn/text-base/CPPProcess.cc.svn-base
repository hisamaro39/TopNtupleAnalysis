...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[0], w[4], pars->GC_2, pars->ZERO, pars->ZERO, w[7]); 
  ...
  FFFF4_5_3(w[0], w[2], w[4], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[44]);
  FFFF3_3(w[0], w[2], w[4], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[45]); 
  FFFF3_7_3(w[0], w[2], w[4], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[46]);
  FFFF4_5_2(w[0], w[3], w[4], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[47]);
  FFFF3_2(w[0], w[3], w[4], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[48]); 
  ...
  FFFF4_5_3(w[3], w[1], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[63]);
  FFFF1_3(w[3], w[1], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[64]); 
  ...
  FFFF4_5_1(w[1], w[5], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[69]);
  FFFF1_1(w[1], w[5], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[70]); 
  FFFF1_6_1(w[1], w[5], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[71]);
  FFFF4_5_4(w[3], w[1], w[5], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[72]);
  FFFF1_4(w[3], w[1], w[5], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[73]); 
...
double CPPProcess::matrix_3_cux_ttxcux() 
{
  int i, j; 
  // Local variables
