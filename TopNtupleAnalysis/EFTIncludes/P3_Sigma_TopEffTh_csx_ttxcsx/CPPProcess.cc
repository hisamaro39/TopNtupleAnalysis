...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF1_6_1(w[2], w[3], w[1], -pars->GC_10, -pars->GC_26, pars->ZERO,
      pars->ZERO, w[52]);
  FFV2_3(w[0], w[1], pars->GC_57, pars->mdl_MW, pars->mdl_WW, w[53]); 
  FFV2_3(w[5], w[4], pars->GC_57, pars->mdl_MW, pars->mdl_WW, w[54]); 
  ...
  FFFF3_2(w[3], w[5], w[4], pars->GC_14, pars->mdl_MB, pars->ZERO, w[60]); 
  FFFF3_2(w[3], w[5], w[4], pars->GC_25, pars->mdl_MB, pars->ZERO, w[61]); 
  ...
  FFFF3_7_3(w[0], w[2], w[4], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[81]);
  FFFF3_3(w[0], w[1], w[2], pars->GC_14, pars->mdl_MB, pars->ZERO, w[82]); 
  FFFF3_3(w[0], w[1], w[2], pars->GC_25, pars->mdl_MB, pars->ZERO, w[83]); 
...
double CPPProcess::matrix_3_csx_ttxcsx() 
{
  int i, j; 
  // Local variables
