...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[0], w[1], pars->GC_2, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFFF4_5_0(w[3], w[1], w[0], w[13], pars->GC_16, pars->GC_17, amp[20]); 
  FFFF1_0(w[3], w[1], w[0], w[13], -pars->GC_13, amp[21]); 
  FFFF1_6_0(w[3], w[1], w[0], w[13], -pars->GC_11, -pars->GC_27, amp[22]); 
  ...
  FFFF4_5_0(w[18], w[1], w[0], w[2], pars->GC_16, pars->GC_17, amp[33]); 
  FFFF1_0(w[18], w[1], w[0], w[2], -pars->GC_13, amp[34]); 
  FFFF1_6_0(w[18], w[1], w[0], w[2], -pars->GC_11, -pars->GC_27, amp[35]); 
  FFV1_0(w[0], w[20], w[6], pars->GC_2, amp[36]); 
  FFV1_0(w[0], w[20], w[7], pars->GC_2, amp[37]); 
  FFV1_0(w[0], w[20], w[8], pars->GC_7, amp[38]); 
  FFV1_0(w[0], w[20], w[9], pars->GC_7, amp[39]); 
  FFV2_7_0(w[0], w[20], w[10], pars->GC_59, pars->GC_69, amp[40]); 
  FFV2_7_0(w[0], w[20], w[11], pars->GC_59, pars->GC_69, amp[41]); 
  FFV2_7_0(w[0], w[20], w[12], pars->GC_59, pars->GC_69, amp[42]); 
  FFFF4_5_0(w[3], w[20], w[0], w[2], pars->GC_16, pars->GC_17, amp[43]); 
  FFFF1_0(w[3], w[20], w[0], w[2], -pars->GC_13, amp[44]); 
  FFFF1_6_0(w[3], w[20], w[0], w[2], -pars->GC_11, -pars->GC_27, amp[45]); 
...
double CPPProcess::matrix_2_uux_ttxg() 
{
  int i, j; 
  // Local variables
