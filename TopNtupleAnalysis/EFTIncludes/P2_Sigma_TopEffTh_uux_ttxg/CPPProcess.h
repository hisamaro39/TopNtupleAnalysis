...
#ifndef MG5_Sigma_TopEffTh_uux_ttxg_H
#define MG5_Sigma_TopEffTh_uux_ttxg_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "u u~ > t t~ g (TopEffTh)";}
...
#endif  // MG5_Sigma_TopEffTh_uux_ttxg_H
