...
#ifndef MG5_Sigma_TopEffTh_gg_ttx_H
#define MG5_Sigma_TopEffTh_gg_ttx_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "g g > t t~ (TopEffTh)";}
...
#endif  // MG5_Sigma_TopEffTh_gg_ttx_H
