...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3(w[5], w[4], pars->GC_57, pars->mdl_MW, pars->mdl_WW, w[53]); 
  FFV2_3(w[0], w[1], pars->GC_57, pars->mdl_MW, pars->mdl_WW, w[54]); 
  ...
  FFFF3_2(w[3], w[0], w[1], pars->GC_14, pars->mdl_MB, pars->ZERO, w[60]); 
  FFFF3_2(w[3], w[0], w[1], pars->GC_25, pars->mdl_MB, pars->ZERO, w[61]); 
  ...
  FFFF1_6_1(w[1], w[5], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[81]);
  FFFF3_3(w[5], w[4], w[2], pars->GC_14, pars->mdl_MB, pars->ZERO, w[82]); 
  FFFF3_3(w[5], w[4], w[2], pars->GC_25, pars->mdl_MB, pars->ZERO, w[83]); 
  FFFF4_5_4(w[3], w[1], w[5], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[84]);
  FFFF1_4(w[3], w[1], w[5], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[85]); 
...
double CPPProcess::matrix_3_dux_ttxdux() 
{
  int i, j; 
  // Local variables
