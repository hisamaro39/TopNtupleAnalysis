...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF1_6_0(w[5], w[44], w[45], w[1], -pars->GC_10, -pars->GC_26, amp[73]); 
  ...
  FFFF1_6_0(w[5], w[44], w[3], w[48], -pars->GC_10, -pars->GC_26, amp[89]); 
  ...
  FFFF1_6_0(w[5], w[65], w[64], w[1], -pars->GC_10, -pars->GC_26, amp[137]); 
  ...
  FFFF1_6_0(w[5], w[2], w[64], w[48], -pars->GC_10, -pars->GC_26, amp[153]); 
  ...
  FFFF1_6_0(w[5], w[65], w[3], w[82], -pars->GC_10, -pars->GC_26, amp[201]); 
  ...
  FFFF1_6_0(w[5], w[2], w[45], w[82], -pars->GC_10, -pars->GC_26, amp[214]); 
...
double CPPProcess::matrix_3_gsx_ttxgsx() 
{
  int i, j; 
  // Local variables
