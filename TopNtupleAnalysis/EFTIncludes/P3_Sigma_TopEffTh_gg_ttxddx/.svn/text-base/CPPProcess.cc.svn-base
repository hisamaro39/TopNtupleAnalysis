...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF1_2_6_0(w[5], w[44], w[45], w[4], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[73]);
  ...
  FFFF1_2_6_0(w[59], w[44], w[3], w[4], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[102]);
  ...
  FFFF1_2_6_0(w[5], w[65], w[64], w[4], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[137]);
  ...
  FFFF1_2_6_0(w[59], w[2], w[64], w[4], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[166]);
  ...
  FFFF1_2_6_0(w[88], w[65], w[3], w[4], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[252]);
  ...
  FFFF1_2_6_0(w[88], w[2], w[45], w[4], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[265]);
...
double CPPProcess::matrix_3_gg_ttxddx() 
{
  int i, j; 
  // Local variables
