...
// Process: g u~ > t t~ g u~ WEIGHTED<=4 @3
// Process: g c~ > t t~ g c~ WEIGHTED<=4 @3
// Process: g d~ > t t~ g d~ WEIGHTED<=4 @3
// Process: g s~ > t t~ g s~ WEIGHTED<=4 @3
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[10]); 
  ...
  FFV1_2(w[5], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[17]); 
  ...
  FFV1_1(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
