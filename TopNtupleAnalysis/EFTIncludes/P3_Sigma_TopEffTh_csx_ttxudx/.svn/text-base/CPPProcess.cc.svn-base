...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3(w[0], w[1], pars->GC_57, pars->mdl_MW, pars->mdl_WW, w[6]); 
  FFV2_3(w[5], w[4], pars->GC_57, pars->mdl_MW, pars->mdl_WW, w[7]); 
  ...
  FFFF3_2(w[3], w[5], w[4], pars->GC_14, pars->mdl_MB, pars->ZERO, w[25]); 
  FFFF3_2(w[3], w[5], w[4], pars->GC_25, pars->mdl_MB, pars->ZERO, w[26]); 
  ...
  FFFF3_7_4(w[0], w[2], w[3], pars->GC_11, pars->GC_27, pars->ZERO, pars->ZERO,
      w[43]);
  FFFF3_3(w[0], w[1], w[2], pars->GC_14, pars->mdl_MB, pars->ZERO, w[44]); 
  FFFF3_3(w[0], w[1], w[2], pars->GC_25, pars->mdl_MB, pars->ZERO, w[45]); 
...
double CPPProcess::matrix_3_csx_ttxudx() 
{
  int i, j; 
  // Local variables
  ...
  jamp[1] = +1./2. * amp[17] + 1./2. * amp[18] + 1./2. * amp[19] + 1./2. *
      ...
      amp[34];
  jamp[2] = +1./2. * amp[39] + 1./2. * amp[40] + 1./2. * amp[41] + 1./2. *
