...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[5], w[1], pars->GC_1, pars->ZERO, pars->ZERO, w[6]); 
  ...
  FFFF4_5_3(w[5], w[2], w[1], pars->GC_15, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[69]);
  FFFF1_3(w[5], w[2], w[1], -pars->GC_12, pars->mdl_MT, pars->mdl_WT, w[70]); 
  ...
  FFFF4_5_2(w[5], w[3], w[1], pars->GC_15, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[72]);
  FFFF1_2(w[5], w[3], w[1], -pars->GC_12, pars->mdl_MT, pars->mdl_WT, w[73]); 
...
double CPPProcess::matrix_3_sdx_ttxsdx() 
{
  int i, j; 
  // Local variables
