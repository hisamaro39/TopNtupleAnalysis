...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF4_5_3(w[5], w[2], w[1], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[38]);
  FFFF3_3(w[5], w[2], w[1], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[39]); 
  FFFF3_7_3(w[5], w[2], w[1], pars->GC_11, pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[40]);
  FFFF4_5_2(w[5], w[3], w[1], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[41]);
  FFFF3_2(w[5], w[3], w[1], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[42]); 
  ...
  FFFF4_5_0(w[5], w[44], w[45], w[1], pars->GC_17, pars->GC_16, amp[71]); 
  FFFF3_0(w[5], w[44], w[45], w[1], pars->GC_13, amp[72]); 
  FFFF3_7_0(w[5], w[44], w[45], w[1], pars->GC_11, pars->GC_27, amp[73]); 
  ...
  FFFF4_5_0(w[5], w[65], w[64], w[1], pars->GC_17, pars->GC_16, amp[135]); 
  FFFF3_0(w[5], w[65], w[64], w[1], pars->GC_13, amp[136]); 
  FFFF3_7_0(w[5], w[65], w[64], w[1], pars->GC_11, pars->GC_27, amp[137]); 
...
double CPPProcess::matrix_3_gcx_ttxgcx() 
{
  int i, j; 
  // Local variables
