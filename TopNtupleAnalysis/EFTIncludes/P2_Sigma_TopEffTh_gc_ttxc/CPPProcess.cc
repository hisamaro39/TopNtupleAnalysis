...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF4_5_0(w[5], w[2], w[3], w[4], pars->GC_17, pars->GC_16, amp[7]); 
  FFFF3_0(w[5], w[2], w[3], w[4], pars->GC_13, amp[8]); 
  FFFF3_7_0(w[5], w[2], w[3], w[4], pars->GC_11, pars->GC_27, amp[9]); 
  ...
  FFFF4_5_0(w[1], w[13], w[3], w[4], pars->GC_17, pars->GC_16, amp[20]); 
  FFFF3_0(w[1], w[13], w[3], w[4], pars->GC_13, amp[21]); 
  FFFF3_7_0(w[1], w[13], w[3], w[4], pars->GC_11, pars->GC_27, amp[22]); 
  ...
  FFFF4_5_0(w[1], w[2], w[18], w[4], pars->GC_17, pars->GC_16, amp[33]); 
  FFFF3_0(w[1], w[2], w[18], w[4], pars->GC_13, amp[34]); 
  FFFF3_7_0(w[1], w[2], w[18], w[4], pars->GC_11, pars->GC_27, amp[35]); 
  ...
  FFFF4_5_0(w[1], w[2], w[3], w[20], pars->GC_17, pars->GC_16, amp[43]); 
  FFFF3_0(w[1], w[2], w[3], w[20], pars->GC_13, amp[44]); 
  FFFF3_7_0(w[1], w[2], w[3], w[20], pars->GC_11, pars->GC_27, amp[45]); 
...
double CPPProcess::matrix_2_gc_ttxc() 
{
  int i, j; 
  // Local variables
