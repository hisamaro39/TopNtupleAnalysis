...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF1_2_6_4(w[1], w[2], w[3], -pars->GC_24, -pars->GC_23, -pars->GC_26,
  ...
  FFFF1_2_6_3(w[1], w[2], w[5], -pars->GC_24, -pars->GC_23, -pars->GC_26,
  ...
  FFFF1_2_6_2(w[1], w[3], w[5], -pars->GC_24, -pars->GC_23, -pars->GC_26,
  ...
  FFFF1_2_6_1(w[2], w[3], w[5], -pars->GC_24, -pars->GC_23, -pars->GC_26,
  ...
  FFFF1_2_6_3(w[1], w[2], w[4], -pars->GC_24, -pars->GC_23, -pars->GC_26,
  ...
  FFFF1_2_6_2(w[1], w[3], w[4], -pars->GC_24, -pars->GC_23, -pars->GC_26,
  ...
  FFFF1_2_6_3(w[0], w[2], w[5], -pars->GC_24, -pars->GC_23, -pars->GC_26,
  ...
  FFFF1_2_6_2(w[0], w[3], w[5], -pars->GC_24, -pars->GC_23, -pars->GC_26,
...
double CPPProcess::matrix_3_dd_ttxdd() 
{
  int i, j; 
  // Local variables
