...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF4_5_3(w[3], w[0], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[27]);
  FFFF1_3(w[3], w[0], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[28]); 
  ...
  FFFF4_5_4(w[4], w[2], w[3], pars->GC_17, pars->GC_16, pars->ZERO, pars->ZERO,
      w[41]);
  FFFF3_4(w[4], w[2], w[3], pars->GC_13, pars->ZERO, pars->ZERO, w[42]); 
...
double CPPProcess::matrix_3_uxsx_ttxcxdx() 
{
  int i, j; 
  // Local variables
