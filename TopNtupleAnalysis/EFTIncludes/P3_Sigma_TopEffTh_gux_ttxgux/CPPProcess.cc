...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[5], w[1], pars->GC_2, pars->ZERO, pars->ZERO, w[23]); 
  ...
  FFFF4_5_0(w[45], w[1], w[5], w[44], pars->GC_16, pars->GC_17, amp[71]); 
  FFFF1_0(w[45], w[1], w[5], w[44], -pars->GC_13, amp[72]); 
  FFFF1_6_0(w[45], w[1], w[5], w[44], -pars->GC_11, -pars->GC_27, amp[73]); 
  ...
  FFFF4_5_0(w[3], w[48], w[5], w[44], pars->GC_16, pars->GC_17, amp[87]); 
  FFFF1_0(w[3], w[48], w[5], w[44], -pars->GC_13, amp[88]); 
  FFFF1_6_0(w[3], w[48], w[5], w[44], -pars->GC_11, -pars->GC_27, amp[89]); 
  ...
  FFFF4_5_0(w[64], w[1], w[5], w[65], pars->GC_16, pars->GC_17, amp[135]); 
  FFFF1_0(w[64], w[1], w[5], w[65], -pars->GC_13, amp[136]); 
  FFFF1_6_0(w[64], w[1], w[5], w[65], -pars->GC_11, -pars->GC_27, amp[137]); 
  ...
  FFFF4_5_0(w[64], w[48], w[5], w[2], pars->GC_16, pars->GC_17, amp[151]); 
  FFFF1_0(w[64], w[48], w[5], w[2], -pars->GC_13, amp[152]); 
  FFFF1_6_0(w[64], w[48], w[5], w[2], -pars->GC_11, -pars->GC_27, amp[153]); 
  ...
  FFFF4_5_0(w[3], w[82], w[5], w[65], pars->GC_16, pars->GC_17, amp[199]); 
  FFFF1_0(w[3], w[82], w[5], w[65], -pars->GC_13, amp[200]); 
  FFFF1_6_0(w[3], w[82], w[5], w[65], -pars->GC_11, -pars->GC_27, amp[201]); 
  ...
  FFFF4_5_0(w[45], w[82], w[5], w[2], pars->GC_16, pars->GC_17, amp[212]); 
  FFFF1_0(w[45], w[82], w[5], w[2], -pars->GC_13, amp[213]); 
  FFFF1_6_0(w[45], w[82], w[5], w[2], -pars->GC_11, -pars->GC_27, amp[214]); 
...
double CPPProcess::matrix_3_gux_ttxgux() 
{
  int i, j; 
  // Local variables
