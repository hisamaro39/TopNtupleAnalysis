...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF4_5_3(w[0], w[2], w[1], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[79]);
  FFFF3_3(w[0], w[2], w[1], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[80]); 
  ...
  FFFF4_5_2(w[0], w[3], w[1], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[84]);
  FFFF3_2(w[0], w[3], w[1], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[85]); 
...
double CPPProcess::matrix_3_ccx_ttxssx() 
{
  int i, j; 
  // Local variables
