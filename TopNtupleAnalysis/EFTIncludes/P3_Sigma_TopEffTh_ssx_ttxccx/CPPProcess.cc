...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF4_5_2(w[5], w[3], w[4], pars->GC_17, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[84]);
  FFFF3_2(w[5], w[3], w[4], pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[85]); 
...
double CPPProcess::matrix_3_ssx_ttxccx() 
{
  int i, j; 
  // Local variables
