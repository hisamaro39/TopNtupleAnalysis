...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[5], w[4], pars->GC_1, pars->ZERO, pars->ZERO, w[6]); 
  ...
  FFFF1_6_1(w[2], w[3], w[1], -pars->GC_10, -pars->GC_26, pars->ZERO,
      pars->ZERO, w[52]);
  FFV1_2(w[5], w[7], pars->GC_1, pars->ZERO, pars->ZERO, w[53]); 
  FFV1_2(w[5], w[30], pars->GC_1, pars->ZERO, pars->ZERO, w[54]); 
  FFV1_2(w[5], w[33], pars->GC_1, pars->ZERO, pars->ZERO, w[55]); 
  FFV1_2(w[5], w[27], pars->GC_7, pars->ZERO, pars->ZERO, w[56]); 
  FFV1_2(w[5], w[28], pars->GC_7, pars->ZERO, pars->ZERO, w[57]); 
  FFV2_4_2(w[5], w[34], pars->GC_58, pars->GC_69, pars->ZERO, pars->ZERO,
      w[58]);
  FFV2_4_2(w[5], w[35], pars->GC_58, pars->GC_69, pars->ZERO, pars->ZERO,
      w[59]);
  FFV2_4_2(w[5], w[36], pars->GC_58, pars->GC_69, pars->ZERO, pars->ZERO,
      w[60]);
  FFV1_2(w[5], w[12], pars->GC_7, pars->ZERO, pars->ZERO, w[61]); 
  FFV2_4_2(w[5], w[13], pars->GC_58, pars->GC_69, pars->ZERO, pars->ZERO,
      w[62]);
  ...
  FFFF4_5_4(w[5], w[2], w[3], pars->GC_15, pars->GC_16, pars->ZERO, pars->ZERO,
      w[66]);
  FFFF1_4(w[5], w[2], w[3], -pars->GC_12, pars->ZERO, pars->ZERO, w[67]); 
  ...
  FFFF4_5_3(w[5], w[2], w[4], pars->GC_15, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[69]);
  FFFF1_3(w[5], w[2], w[4], -pars->GC_12, pars->mdl_MT, pars->mdl_WT, w[70]); 
  ...
  FFFF4_5_2(w[5], w[3], w[4], pars->GC_15, pars->GC_16, pars->mdl_MT,
      pars->mdl_WT, w[72]);
  FFFF1_2(w[5], w[3], w[4], -pars->GC_12, pars->mdl_MT, pars->mdl_WT, w[73]); 
  ...
  FFV1_0(w[5], w[63], w[7], pars->GC_1, amp[193]); 
  FFV1_0(w[5], w[64], w[7], pars->GC_1, amp[194]); 
  FFV1_0(w[5], w[65], w[7], pars->GC_1, amp[195]); 
  FFV1_0(w[5], w[63], w[12], pars->GC_7, amp[196]); 
  FFV1_0(w[5], w[64], w[12], pars->GC_7, amp[197]); 
  FFV1_0(w[5], w[65], w[12], pars->GC_7, amp[198]); 
  FFV2_4_0(w[5], w[63], w[13], pars->GC_58, pars->GC_69, amp[199]); 
  FFV2_4_0(w[5], w[64], w[13], pars->GC_58, pars->GC_69, amp[200]); 
  FFV2_4_0(w[5], w[65], w[13], pars->GC_58, pars->GC_69, amp[201]); 
...
double CPPProcess::matrix_3_ssx_ttxddx() 
{
  int i, j; 
  // Local variables
