...
#ifndef MG5_Sigma_TopEffTh_ssx_ttxg_H
#define MG5_Sigma_TopEffTh_ssx_ttxg_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "s s~ > t t~ g (TopEffTh)";}
...
#endif  // MG5_Sigma_TopEffTh_ssx_ttxg_H
