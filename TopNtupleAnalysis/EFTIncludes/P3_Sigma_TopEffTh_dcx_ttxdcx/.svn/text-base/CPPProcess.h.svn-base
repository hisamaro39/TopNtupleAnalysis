...
#ifndef MG5_Sigma_TopEffTh_dcx_ttxdcx_H
#define MG5_Sigma_TopEffTh_dcx_ttxdcx_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "d c~ > t t~ d c~ (TopEffTh)";}
...
#endif  // MG5_Sigma_TopEffTh_dcx_ttxdcx_H
