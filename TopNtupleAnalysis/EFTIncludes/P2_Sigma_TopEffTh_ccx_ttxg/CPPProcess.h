...
#ifndef MG5_Sigma_TopEffTh_ccx_ttxg_H
#define MG5_Sigma_TopEffTh_ccx_ttxg_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "c c~ > t t~ g (TopEffTh)";}
...
#endif  // MG5_Sigma_TopEffTh_ccx_ttxg_H
