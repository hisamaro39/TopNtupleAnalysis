...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[4], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[6]); 
  FFV1P0_3(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[7]); 
  ...
  FFV1P0_3(w[4], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1P0_3(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[14]); 
  ...
  FFV1_2(w[4], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[4], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1_2(w[4], w[7], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
