...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_7_1(w[5], w[19], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[40]);
  FFFF4_5_2(w[3], w[1], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[41]);
  FFFF1_2(w[3], w[1], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[42]); 
  FFFF1_6_2(w[3], w[1], w[2], -pars->GC_11, -pars->GC_27, pars->ZERO,
      pars->ZERO, w[43]);
  FFFF4_5_1(w[5], w[1], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[44]);
  FFFF1_1(w[5], w[1], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[45]); 
  FFFF1_6_1(w[5], w[1], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[46]);
  FFFF4_5_4(w[3], w[5], w[1], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[47]);
  FFFF1_4(w[3], w[5], w[1], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[48]); 
  FFFF1_6_4(w[3], w[5], w[1], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[49]);
  FFFF4_5_3(w[3], w[5], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[50]);
  FFFF1_3(w[3], w[5], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[51]); 
  FFFF1_6_3(w[3], w[5], w[2], -pars->GC_11, -pars->GC_27, pars->ZERO,
      pars->ZERO, w[52]);
  ...
  FFV2_7_1(w[4], w[66], pars->GC_59, pars->GC_69, pars->ZERO, pars->ZERO,
      w[78]);
  FFFF4_5_1(w[4], w[1], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[79]);
  FFFF1_1(w[4], w[1], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[80]); 
  FFFF1_6_1(w[4], w[1], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[81]);
  FFFF4_5_4(w[3], w[4], w[1], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[82]);
  FFFF1_4(w[3], w[4], w[1], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[83]); 
  FFFF1_6_4(w[3], w[4], w[1], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[84]);
  FFFF4_5_3(w[3], w[4], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[85]);
  FFFF1_3(w[3], w[4], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[86]); 
  FFFF1_6_3(w[3], w[4], w[2], -pars->GC_11, -pars->GC_27, pars->ZERO,
      pars->ZERO, w[87]);
  ...
  FFFF4_5_2(w[3], w[0], w[2], pars->GC_16, pars->GC_17, pars->ZERO, pars->ZERO,
      w[101]);
  FFFF1_2(w[3], w[0], w[2], -pars->GC_13, pars->ZERO, pars->ZERO, w[102]); 
  FFFF1_6_2(w[3], w[0], w[2], -pars->GC_11, -pars->GC_27, pars->ZERO,
      pars->ZERO, w[103]);
  FFFF4_5_1(w[4], w[0], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[104]);
  FFFF1_1(w[4], w[0], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[105]); 
  FFFF1_6_1(w[4], w[0], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[106]);
  FFFF4_5_1(w[5], w[0], w[2], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[107]);
  FFFF1_1(w[5], w[0], w[2], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[108]); 
  FFFF1_6_1(w[5], w[0], w[2], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[109]);
  FFFF4_5_4(w[3], w[4], w[0], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[110]);
  FFFF1_4(w[3], w[4], w[0], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[111]); 
  FFFF1_6_4(w[3], w[4], w[0], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[112]);
  FFFF4_5_4(w[3], w[5], w[0], pars->GC_16, pars->GC_17, pars->mdl_MT,
      pars->mdl_WT, w[113]);
  FFFF1_4(w[3], w[5], w[0], -pars->GC_13, pars->mdl_MT, pars->mdl_WT, w[114]); 
  FFFF1_6_4(w[3], w[5], w[0], -pars->GC_11, -pars->GC_27, pars->mdl_MT,
      pars->mdl_WT, w[115]);
...
double CPPProcess::matrix_3_uu_ttxuu() 
{
  int i, j; 
  // Local variables
