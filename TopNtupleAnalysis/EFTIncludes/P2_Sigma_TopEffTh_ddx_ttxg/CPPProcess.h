...
#ifndef MG5_Sigma_TopEffTh_ddx_ttxg_H
#define MG5_Sigma_TopEffTh_ddx_ttxg_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "d d~ > t t~ g (TopEffTh)";}
...
#endif  // MG5_Sigma_TopEffTh_ddx_ttxg_H
