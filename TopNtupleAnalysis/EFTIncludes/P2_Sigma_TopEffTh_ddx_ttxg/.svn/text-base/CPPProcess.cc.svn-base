...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFFF1_2_6_0(w[0], w[13], w[3], w[1], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[22]);
  ...
  FFFF1_2_6_0(w[0], w[2], w[18], w[1], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[35]);
  ...
  FFFF1_2_6_0(w[0], w[2], w[3], w[20], -pars->GC_24, -pars->GC_23,
      -pars->GC_26, amp[45]);
...
double CPPProcess::matrix_2_ddx_ttxg() 
{
  int i, j; 
  // Local variables
