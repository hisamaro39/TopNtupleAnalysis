 ...
 */
#ifndef ANATTRES21_ELECTRON_H
#define ANATTRES21_ELECTRON_H
...
class AnaTtres21_electron : public Analysis {
  public:
    AnaTtres21_electron(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtres21_electron();
