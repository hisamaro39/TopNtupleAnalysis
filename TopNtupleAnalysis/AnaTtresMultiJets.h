 ...
 */
#ifndef ANATTRESMULTIJETS_H
#define ANATTRESMULTIJETS_H
...
class AnaTtresMultiJets : public AnalysisValidation {
  public:
    AnaTtresMultiJets(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresMultiJets();
