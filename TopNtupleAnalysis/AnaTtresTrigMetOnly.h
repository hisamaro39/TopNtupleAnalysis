 ...
 */
#ifndef ANATTRESTRIGMETONLY_H
#define ANATTRESTRIGMETONLY_H
...
class AnaTtresTrigMetOnly : public AnalysisTrig {
  public:
    AnaTtresTrigMetOnly(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresTrigMetOnly();
