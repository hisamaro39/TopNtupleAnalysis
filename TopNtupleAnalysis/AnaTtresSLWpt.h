 ...
 */
#ifndef ANATTRESSLWPT_H
#define ANATTRESSLWPT_H
...
class AnaTtresSLWpt : public AnalysisTrig {
  public:
    AnaTtresSLWpt(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresSLWpt();
