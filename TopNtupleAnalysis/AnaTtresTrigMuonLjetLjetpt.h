 ...
 */
#ifndef ANATTRESTRIGMUONLJETLJETPT_H
#define ANATTRESTRIGMUONLJETLJETPT_H
...
class AnaTtresTrigMuonLjetLjetpt : public Analysis {
  public:
    AnaTtresTrigMuonLjetLjetpt(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresTrigMuonLjetLjetpt();
