 ...
 */
#ifndef ANATTRESTRIGMUONMETNOWPT_H
#define ANATTRESTRIGMUONMETNOWPT_H
...
class AnaTtresTrigMuonMetNoWpt : public Analysis {
  public:
    AnaTtresTrigMuonMetNoWpt(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresTrigMuonMetNoWpt();
