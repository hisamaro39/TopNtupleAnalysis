 ...
 */
#ifndef ANATTRESFULLHAD_H
#define ANATTRESFULLHAD_H
...
class AnaTtresFullHad : public Analysis {
  public:
    AnaTtresFullHad(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresFullHad();
