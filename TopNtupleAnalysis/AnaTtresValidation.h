 ...
 */
#ifndef ANATTRESVALIDATION_H
#define ANATTRESVALIDATION_H
...
class AnaTtresValidation : public AnalysisValidation {
  public:
    AnaTtresValidation(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresValidation();
