 ...
 */
#ifndef ANATTRESCHECKTRIGGER_H
#define ANATTRESCHECKTRIGGER_H
...
class AnaTtresCheckTrigger : public AnalysisValidation {
  public:
    AnaTtresCheckTrigger(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresCheckTrigger();
