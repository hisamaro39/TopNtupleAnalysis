 ...
 */
#ifndef ANATTRESVRBTAG_H
#define ANATTRESVRBTAG_H
...
class AnaTtresVRBtag : public Analysis {
  public:
    AnaTtresVRBtag(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresVRBtag();
