 ...
 */
#ifndef ANATTRESNOTRIGGER_H
#define ANATTRESNOTRIGGER_H
...
class AnaTtresNoTrigger : public Analysis {
  public:
    AnaTtresNoTrigger(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresNoTrigger();
