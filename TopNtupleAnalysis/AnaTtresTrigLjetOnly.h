 ...
 */
#ifndef ANATTRESTRIGLJETONLY_H
#define ANATTRESTRIGLJETONLY_H
...
class AnaTtresTrigLjetOnly : public Analysis {
  public:
    AnaTtresTrigLjetOnly(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresTrigLjetOnly();
