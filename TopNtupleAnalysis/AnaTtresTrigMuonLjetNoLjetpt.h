 ...
 */
#ifndef ANATTRESTRIGMUONLJETNOLJETPT_H
#define ANATTRESTRIGMUONLJETNOLJETPT_H
...
class AnaTtresTrigMuonLjetNoLjetpt : public Analysis {
  public:
    AnaTtresTrigMuonLjetNoLjetpt(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresTrigMuonLjetNoLjetpt();
