 ...
 */
#ifndef ANATTRESTRUTHRESOLVED_H
#define ANATTRESTRUTHRESOLVED_H
...
class AnaTtresTruthResolved : public Analysis {
  public:
    AnaTtresTruthResolved(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresTruthResolved();
