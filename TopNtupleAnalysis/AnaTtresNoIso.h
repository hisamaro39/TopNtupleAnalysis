 ...
 */
#ifndef ANATTRESNOISO_H
#define ANATTRESNOISO_H
...
class AnaTtresNoIso : public Analysis {
  public:
    AnaTtresNoIso(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList);
    virtual ~AnaTtresNoIso();
