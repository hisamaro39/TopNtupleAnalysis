...
AnaTtresTrigMuonLjetNoLjetpt::AnaTtresTrigMuonLjetNoLjetpt(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList)
...
AnaTtresTrigMuonLjetNoLjetpt::~AnaTtresTrigMuonLjetNoLjetpt() {
}

void AnaTtresTrigMuonLjetNoLjetpt::run(const Event &evt, double weight, const std::string &s, int is2016run) {
