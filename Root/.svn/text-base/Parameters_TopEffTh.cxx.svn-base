...
Parameters_TopEffTh * Parameters_TopEffTh::instance = 0; 

// Function to get static instance - only one instance per program
Parameters_TopEffTh * Parameters_TopEffTh::getInstance()
{
  if (instance == 0)
    instance = new Parameters_TopEffTh(); 

  return instance; 
}

void Parameters_TopEffTh::setIndependentParameters(SLHAReader& slha)
{
  // Define "zero"
  zero = 0; 
  ZERO = 0; 
  ...
  mdl_Lambda__exp__2 = pow(mdl_Lambda, 2.); 
...
void Parameters_TopEffTh::setIndependentCouplings()
{
  ...
  GC_60 = (mdl_cw * mdl_ee * mdl_complexi)/mdl_sw; 
  ...
  GC_80 = (mdl_CtW * mdl_complexi * mdl_vev)/mdl_Lambda__exp__2; 
  GC_81 = (mdl_CtW * mdl_cw * mdl_complexi * mdl_vev)/(mdl_Lambda__exp__2 *
      mdl_sqrt__2);
  GC_87 = (mdl_ee__exp__2 * mdl_complexi * mdl_vev)/(2. * mdl_sw__exp__2); 
  GC_89 = (mdl_CtW * mdl_ee * mdl_complexi * mdl_vev)/(mdl_Lambda__exp__2 *
      mdl_sw * mdl_sqrt__2);
  GC_91 = (mdl_CtW * mdl_complexi * mdl_sw * mdl_vev)/(mdl_Lambda__exp__2 *
      mdl_sqrt__2);
  GC_92 = (mdl_C3phiq * mdl_ee * mdl_complexi *
      mdl_vev__exp__2)/(mdl_Lambda__exp__2 * mdl_sw * mdl_sqrt__2);
  GC_93 = mdl_ee__exp__2 * mdl_complexi * mdl_vev + (mdl_cw__exp__2 *
  ...
  GC_108 = (mdl_ee * mdl_complexi * mdl_vev__exp__2 *
      mdl_conjg__C3phiq)/(mdl_Lambda__exp__2 * mdl_sw * mdl_sqrt__2);
  GC_128 = (mdl_C3phiq * mdl_complexi * mdl_vev)/(2. * mdl_Lambda__exp__2) -
      (mdl_complexi * mdl_vev * mdl_conjg__C3phiq)/(2. * mdl_Lambda__exp__2);
  ...
  GC_165 = (mdl_complexi * mdl_vev * mdl_conjg__CtW)/mdl_Lambda__exp__2; 
  GC_166 = (mdl_cw * mdl_complexi * mdl_vev *
      mdl_conjg__CtW)/(mdl_Lambda__exp__2 * mdl_sqrt__2);
  GC_168 = (mdl_ee * mdl_complexi * mdl_vev *
      mdl_conjg__CtW)/(mdl_Lambda__exp__2 * mdl_sw * mdl_sqrt__2);
  GC_170 = (mdl_complexi * mdl_sw * mdl_vev *
      mdl_conjg__CtW)/(mdl_Lambda__exp__2 * mdl_sqrt__2);
  GC_10 = (mdl_C81qq * mdl_complexi)/mdl_Lambda__exp__2 - (mdl_C83qq *
      mdl_complexi)/mdl_Lambda__exp__2;
  GC_11 = (mdl_C81qq * mdl_complexi)/mdl_Lambda__exp__2 + (mdl_C83qq *
      mdl_complexi)/mdl_Lambda__exp__2;
  GC_12 = -((mdl_C13qq * mdl_complexi)/mdl_Lambda__exp__2); 
  GC_13 = (mdl_C13qq * mdl_complexi)/mdl_Lambda__exp__2; 
  GC_14 = (2. * mdl_C13qq * mdl_complexi)/mdl_Lambda__exp__2; 
  ...
  GC_25 = (2. * mdl_C83qq * mdl_complexi)/mdl_Lambda__exp__2; 
...
void Parameters_TopEffTh::setDependentCouplings()
{
  ...
  GC_50 = (3. * mdl_CG * mdl_G__exp__2)/mdl_Lambda__exp__2; 
  GC_49 = (-3. * mdl_CG * mdl_G__exp__2)/mdl_Lambda__exp__2; 
  GC_44 = (6. * mdl_CG * mdl_complexi * G)/mdl_Lambda__exp__2; 
  GC_84 = (2. * mdl_CphiG * G * mdl_vev)/mdl_Lambda__exp__2; 
  GC_85 = -((mdl_CtG * G * mdl_vev * mdl_sqrt__2)/mdl_Lambda__exp__2); 
  GC_86 = (-2. * mdl_CphiG * mdl_complexi * mdl_G__exp__2 *
      mdl_vev)/mdl_Lambda__exp__2;
}
