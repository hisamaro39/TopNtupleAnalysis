...
AnaTtresTrigMuonMetNoWpt::AnaTtresTrigMuonMetNoWpt(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList)
...
AnaTtresTrigMuonMetNoWpt::~AnaTtresTrigMuonMetNoWpt() {
}

void AnaTtresTrigMuonMetNoWpt::run(const Event &evt, double weight, const std::string &s, int is2016run) {
