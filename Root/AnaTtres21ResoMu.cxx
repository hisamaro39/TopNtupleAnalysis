...
AnaTtres21ResoMu::AnaTtres21ResoMu(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList)
...
AnaTtres21ResoMu::~AnaTtres21ResoMu() {
}

void AnaTtres21ResoMu::run(const Event &evt, double weight, const std::string &s, int is2016run) {
  std::cout << "AnaTtres21ResoMu::run" << std::endl;
  ...
  std::cout << "mu26/mu50=" << pass_mu26_ivarmedium << "/" << pass_mu50 << std::endl;
  ...
  //Trigger matching
  //trig1 = evt.muon()[muon_id_nocalib].HLT_mu26_ivarmedium();
  //trig2 = evt.muon()[muon_id_nocalib].HLT_mu50();
