...
AnaTtresSLWpt::AnaTtresSLWpt(const std::string &filename, bool electron, bool boosted, std::vector<std::string> &systList)
...
AnaTtresSLWpt::~AnaTtresSLWpt() {
}

void AnaTtresSLWpt::run(const Event &evt, double weight, const std::string &s, int is2016run, int trthr) {
