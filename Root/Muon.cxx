...
const bool Muon::HLT_mu26_ivarmedium() const {
  return m_HLT_mu26_ivarmedium;
}
bool &Muon::HLT_mu26_ivarmedium() {
  return m_HLT_mu26_ivarmedium;
}
...
const int Muon::trigger_match() const {
  return m_trigger_match;
}
int &Muon::trigger_match() {
  return m_trigger_match;
}
